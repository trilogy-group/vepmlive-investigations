...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <asp:Panel ID="pnlParentChild" runat="server" Visible="false">
        ...
        <div id="div3" style="width: 200; padding: 10px">
            <table>
                <tr>
                    <td>Select Project:
                        <asp:DropDownList ID="ddlChildParent" runat="server"></asp:DropDownList></td>
                </tr>
                <tr>
    ...
    <asp:Panel ID="pnlTemplate" runat="server" Visible="false">
        ...
        <script>
            $(function () {
                //Background process takes 3-4 sec to complete so I am using 5 sec here.   
                setTimeout(ResizePopop, 5000)
            })
            function ResizePopop() {
                ...
                if (dlgContent.attr('DragBehavior') !== null && dlgContent.css('left') !== '10px') {
                    ...
                    dlgInnerFrame.css({ height: (formH + 10) + 'px' });
                }
            }
