...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportExcel.aspx.cs" Inherits="EPMLiveWorkPlanner.Layouts.epmlive.ImportExcel" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:HiddenField ID="hdnFilename" runat="server" />
            ...
            <table width="100%">
                <tr>
                    <td align="center" class="ms-sectionheader">
                        ...
                        <H3 class="ms-standardheader">Uploading File...</h3>
                    </td>
                </tr>
    ...
    <asp:Panel ID="pnlSheet" runat="server" Visible="false">

        Select Sheet: <asp:DropDownList ID="ddlSheet" runat="server"></asp:DropDownList><br />

        <asp:Button ID="Button1" runat="server" Text="Next >" OnClick="btnSheet_Click"  />
    ...
    <asp:Panel ID="pnlColumns" runat="server" Visible="false">
        ...
        <asp:GridView ID="gvColumns" runat="server" OnRowDataBound="gvColumns_RowDataBound" AutoGenerateColumns="false">
            <Columns>
                <asp:BoundField HeaderText="Excel Field" DataField="ExcelField" ItemStyle-Width="200px" />
        ...
        <div id="dlgImport" class="dialog">
            <table width="100%">
                <tr>
                    <td align="center" class="ms-sectionheader">
                        <img src="../images/GEARS_ANv4.GIF" style="vertical-align: middle;"/><br />
                        <H3 class="ms-standardheader">Starting Import...</h3>
                    </td>
                </tr>
            </table>
        </div> 
