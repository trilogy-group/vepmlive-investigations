...
namespace EPMLiveEnterprise
{
    class Publisher
    {
        ...
        private CustomFieldsDerived pCf;
        private ResourceDerived pResource;
        private ProjectDerived pService;
        private LookupTableDerived psiLookupTable;
        private StatusingDerived Statusing;
        private WssInteropDerived pWssInterop;
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    using (SPSite pubSite = new SPSite(publishSiteUrl))
                    {
                        ...
                        pCf = EPMLiveHelperClasses.GetCustomFieldsDerivedObject(mySite.Url);
                        //pCf = new CustomFieldsDerived();
                        //pCf.Url = mySite.Url + "/_vti_bin/psi/customfields.asmx";
                        //pCf.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                        //pCf.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(mySite.Url);
                        //pCf.EnforceWindowsAuth = true;

                        cfDs = new WebSvcCustomFields.CustomFieldDataSet();

                        psiLookupTable = EPMLiveHelperClasses.GetLookupTableDerivedObject(mySite.Url);
                        //psiLookupTable = new LookupTableDerived();
                        //psiLookupTable.Url = mySite.Url + "/_vti_bin/psi/lookuptable.asmx";
                        //psiLookupTable.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                        //psiLookupTable.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(mySite.Url);
                        //psiLookupTable.EnforceWindowsAuth = true;

                        pResource = EPMLiveHelperClasses.GetResourceDerivedObject(mySite.Url);
                        //pResource = new ResourceDerived();
                        //pResource.Url = mySite.Url + "/_vti_bin/psi/resource.asmx";
                        //pResource.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                        //pResource.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(mySite.Url);
                        //pResource.EnforceWindowsAuth = true;

                        pService = EPMLiveHelperClasses.GetProjectDerivedObject(mySite.Url);
                        //pService = new ProjectDerived();
                        //pService.Url = mySite.Url + "/_vti_bin/psi/project.asmx";
                        //pService.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                        //pService.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(mySite.Url);
                        //pService.EnforceWindowsAuth = true;

                        Statusing = EPMLiveHelperClasses.GetStatusingDerivedObject(mySite.Url);
                        //Statusing = new StatusingDerived();
                        //Statusing.Url = mySite.Url + "/_vti_bin/psi/statusing.asmx";
                        //Statusing.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                        //Statusing.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(mySite.Url);
                        //Statusing.EnforceWindowsAuth = true;

                        pWssInterop = EPMLiveHelperClasses.GetWssInteropDerivedObject(mySite.Url);
                        //pWssInterop = new WssInteropDerived();
                        //pWssInterop.Url = mySite.Url + "/_vti_bin/psi/wssinterop.asmx";
                        //pWssInterop.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                        //pWssInterop.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(mySite.Url);
                        //pWssInterop.EnforceWindowsAuth = true;
        ...
        private string getProjectWss(string pwaUrl, Guid projectUID)
        {
            ...
            try
            {
                ...
                WssInteropDerived wssInterop = EPMLiveHelperClasses.GetWssInteropDerivedObject(pwaUrl);
                //WssInteropDerived wssInterop = new WssInteropDerived();
                //wssInterop.Url = pwaUrl + "/_vti_bin/psi/wssinterop.asmx";
                //wssInterop.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                //wssInterop.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(pwaUrl);
        ...
        public bool IsAssignedTaskSaved(Guid assnid)
        {
            try
            {
                StatusingDerived status = EPMLiveHelperClasses.GetStatusingDerivedObject(mySite.Url);
                //StatusingDerived status = new StatusingDerived();
                //status.Url = mySite.Url + "/_vti_bin/psi/statusing.asmx";
                //status.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                //status.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(mySite.Url);
                //status.EnforceWindowsAuth = true;
