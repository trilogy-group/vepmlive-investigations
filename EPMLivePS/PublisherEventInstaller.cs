    ...
    class PublisherEventInstaller : SPFeatureReceiver
    {
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            ...
            try
            {
                ...
                WssInteropDerived wss = EPMLiveHelperClasses.GetWssInteropDerivedObject(SPContext.Current.Site.Url);
                //WssInteropDerived wss = new WssInteropDerived();
                //wss.Url = SPContext.Current.Site.Url + "/_vti_bin/psi/wssinterop.asmx";
                //wss.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                //wss.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(SPContext.Current.Site.Url);
                //wss.EnforceWindowsAuth = true;
