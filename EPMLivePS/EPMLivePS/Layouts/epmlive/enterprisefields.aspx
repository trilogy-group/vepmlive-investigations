                ...
                <tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="300">
                            ...
                            <tr>
                                <td colspan="3" bgcolor="#F8F8F8" class="ms-sectionheader" style="border-left: solid 1px #9C9C9C; border-right: solid 1px #9C9C9C; border-bottom: solid 1px #9C9C9C; padding:3px">
                                    <font class="ms-descriptiontext">Custom Fields</font> <a href="#" class="ms-" onclick="window.open('<%=serverUrl %>/_layouts/epmlive/addfield.aspx?type=2&pj=1','addfield','height=250,width=250,toolbar=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes');">[Add Field]</a>
                                </td>
                            </tr>
                            <%=pjcustomFields %>
                            <tr>
                                <td colspan="3" bgcolor="#F8F8F8" class="ms-sectionheader" style="border-left: solid 1px #9C9C9C; border-right: solid 1px #9C9C9C; border-bottom: solid 1px #9C9C9C; padding:3px">
                                    <font class="ms-descriptiontext">Task Enterprise Fields</font> <a href="#" class="ms-" onclick="window.open('<%=serverUrl %>/_layouts/epmlive/addfield.aspx?type=3&pj=1','addfield','height=250,width=250,toolbar=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes');">[Add Field]</a>
                                </td>
                            </tr>
                            <%=pjenterpriseFields %>
                            <tr>
                                <td colspan="3" bgcolor="#F8F8F8" class="ms-sectionheader" style="border-left: solid 1px #9C9C9C; border-right: solid 1px #9C9C9C; border-bottom: solid 1px #9C9C9C; padding:3px">
                                    <font class="ms-descriptiontext">Project Enterprise Fields</font> <a href="#" class="ms-" onclick="window.open('<%=serverUrl %>/_layouts/epmlive/addfield.aspx?type=4&pj=1','addfield','height=250,width=250,toolbar=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes');">[Add Field]</a>
                                </td>
                            </tr>
                    ...
                    <td valign="top">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="300">
                            ...
                            <tr>
                                <td colspan="3" bgcolor="#F8F8F8" class="ms-sectionheader" style="border-left: solid 1px #9C9C9C; border-right: solid 1px #9C9C9C; border-bottom: solid 1px #9C9C9C; padding:3px">
                                    <font class="ms-descriptiontext">Custom Fields</font> <a href="#" class="ms-" onclick="window.open('<%=serverUrl %>/_layouts/epmlive/addfield.aspx?type=2','addfield','height=250,width=300,toolbar=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes');">[Add Field]</a>
                                </td>
                            </tr>
                            <%=customFields %>
                            <tr>
                                <td colspan="3" bgcolor="#F8F8F8" class="ms-sectionheader" style="border-left: solid 1px #9C9C9C; border-right: solid 1px #9C9C9C; border-bottom: solid 1px #9C9C9C; padding:3px">
                                    <font class="ms-descriptiontext">Task Enterprise Fields</font> <a href="#" class="ms-" onclick="window.open('<%=serverUrl %>/_layouts/epmlive/addfield.aspx?type=3','addfield','height=250,width=300,toolbar=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=yes');">[Add Field]</a>
                                </td>
                            </tr>
                            <%=enterpriseFields %>
                        </table>    
...
<script language="javascript">
    ...
    function runSynch() {
        ...
        dhtmlxAjax.post("<%=serverUrl%>/_layouts/epmlive/runenterprisesynch.aspx", "", closeDone);
    }
    ...
    function closeDone(loader) {
        if (loader.xmlDoc.responseText != null) {
            if (loader.xmlDoc.responseText.substring(0, 5) != "Error") {
                ...
                newURL = "<%=serverUrl%>/_layouts/epmlive/enterprisefields.aspx";
