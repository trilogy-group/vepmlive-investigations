    ...
    class ResourceSyncher
    {
        ...
        public ResourceSyncher(Guid siteId)
        {
            ...
            using (SPSite site = new SPSite(siteGuid))
            {
                ...
                //pCf.Credentials = System.Net.CredentialCache.DefaultCredentials;

                CustomFieldsDerived pCf = EPMLiveHelperClasses.GetCustomFieldsDerivedObject(site.Url);
                //CustomFieldsDerived pCf = new CustomFieldsDerived();
                //pCf.Url = site.Url + "/_vti_bin/psi/customfields.asmx";
                //pCf.Credentials = EPMLiveHelperClasses.GetNetworkCredential(); //CredentialCache.DefaultCredentials; //CredentialCache.DefaultNetworkCredentials; 
                //pCf.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(site.Url);
                //pCf.EnforceWindowsAuth = true;

                cfDs = new WebSvcCustomFields.CustomFieldDataSet();
                cfDs = pCf.ReadCustomFieldsByEntity(resEntity);

                psiLookupTable = EPMLiveHelperClasses.GetLookupTableDerivedObject(site.Url);
                ...
                //psiLookupTable.Credentials = EPMLiveHelperClasses.GetNetworkCredential(); //CredentialCache.DefaultCredentials; //CredentialCache.DefaultNetworkCredentials;
                //psiLookupTable.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(site.Url);
                //psiLookupTable.EnforceWindowsAuth = true;

                //pResource = new WebSvcResource.Resource();
                pResource = EPMLiveHelperClasses.GetResourceDerivedObject(site.Url);
                //pResource = new ResourceDerived();
                //pResource.Url = site.Url + "/_vti_bin/psi/resource.asmx";
                ////pResource.UseDefaultCredentials = true;
                //pResource.Credentials = EPMLiveHelperClasses.GetNetworkCredential(); //CredentialCache.DefaultCredentials;   //CredentialCache.DefaultNetworkCredentials;
                //pResource.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(site.Url);
