...
namespace EPMLiveEnterprise
{
    public class ProjectWorkspaceSynch
    {
        ...
        private ProjectDerived psiProject;
        private ResourceDerived psiResource;
        ...
        public ProjectWorkspaceSynch(Guid projectSiteGuid, string webUrl, Guid projectGuid, string username)
        {
            try
            {
                ...
                CustomFieldsDerived pCf = EPMLiveHelperClasses.GetCustomFieldsDerivedObject(mySite.Url);
                ...
                ProjectDerived psiProject = EPMLiveHelperClasses.GetProjectDerivedObject(mySite.Url);
                //psiProject = new ProjectDerived();
                //psiProject.Url = mySite.Url + "/_vti_bin/psi/project.asmx";
                //psiProject.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                //psiProject.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(mySite.Url);
                //psiProject.EnforceWindowsAuth = true;

                psiResource = EPMLiveHelperClasses.GetResourceDerivedObject(mySite.Url);
                //psiResource = new ResourceDerived();
                //psiResource.Url = mySite.Url + "/_vti_bin/psi/resource.asmx";
                ////pResource.UseDefaultCredentials = true;
                //psiResource.Credentials = EPMLiveHelperClasses.GetNetworkCredential(); //CredentialCache.DefaultCredentials;   //CredentialCache.DefaultNetworkCredentials;
                //psiResource.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(mySite.Url);
                //psiResource.EnforceWindowsAuth = true;
