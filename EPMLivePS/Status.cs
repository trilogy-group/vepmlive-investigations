    ...
    public class Status : StatusingEventReceiver
    {
        ...
        public void HandleWSSUpdate(Microsoft.Office.Project.Server.Library.PSContextInfo contextInfo, string acceptdecline, Guid assnid, Guid projectid)
        {
            try
            {
                ...
                StatusingDerived statusing = EPMLiveHelperClasses.GetStatusingDerivedObject(site.Url);
                //StatusingDerived statusing = new StatusingDerived();
                //statusing.Url = site.Url + "/_vti_bin/psi/statusing.asmx";
                //statusing.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                //statusing.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(site.Url);
        ...
        private Guid getProjectOwner(string url, Guid projectuid)
        {
            try
            {
                ...
                ProjectDerived pService = EPMLiveHelperClasses.GetProjectDerivedObject(url);
                //ProjectDerived pService = new ProjectDerived();
                //pService.Url = url + "/_vti_bin/psi/project.asmx";
                //pService.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                //pService.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(url);
        ...
        private string getResourceUsername(string url, Guid RES_GUID)
        {
            try
            {
                ...
                ResourceDerived pResource = EPMLiveHelperClasses.GetResourceDerivedObject(url);
                //ResourceDerived pResource = new ResourceDerived();
                //pResource.Url = url + "/_vti_bin/psi/resource.asmx";
                //pResource.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                //pResource.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(url);
        ...
        private string GetWindowsAccountByResGUID(string ls_guid, Microsoft.Office.Project.Server.Library.PSContextInfo contextInfo, string url)
        {
            ...
            try
            {
                ...
                ResourceDerived Resource = EPMLiveHelperClasses.GetResourceDerivedObject(url);
                //ResourceDerived Resource = new ResourceDerived();
                //Resource.Url = url + "/_vti_bin/psi/resource.asmx";
                //Resource.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                //Resource.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(url);
