...
{
    public partial class getpswebapp : LayoutsPageBase
    {
        protected Panel pnlOpenProject;
        protected Panel pnlNewProject;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                using (SPWeb spWeb = SPContext.Current.Web)
                {
                    ...
                    ProjectDerived project = EPMLiveHelperClasses.GetProjectDerivedObject(ViewState["siteURL"].ToString());
                    //ProjectDerived project = new ProjectDerived();
                    //project.Url = ViewState["siteURL"] + "/_vti_bin/psi/project.asmx";
                    //project.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                    //project.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(ViewState["siteURL"].ToString());
        ...
        private void WaitForQueue(Guid jobId)
        {
            ...
            QueueSystemDerived q = EPMLiveHelperClasses.GetQueueSystemDerivedObject(ViewState["siteURL"].ToString());
            //QueueSystemDerived q = new QueueSystemDerived();
            //q.Url = ViewState["siteURL"] + "/_vti_bin/psi/queuesystem.asmx";
            //q.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
            //q.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(ViewState["siteURL"].ToString());
            //q.EnforceWindowsAuth = true;
        ...
        private Guid getResourceUid()
        {
            ...
            ResourceDerived re = EPMLiveHelperClasses.GetResourceDerivedObject(ViewState["siteURL"].ToString());
            //ResourceDerived re = new ResourceDerived();
            //re.Url = ViewState["siteURL"] + "/_vti_bin/PSI/resource.asmx";
            //re.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
            //re.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(ViewState["siteURL"].ToString());
            //re.EnforceWindowsAuth = true;
