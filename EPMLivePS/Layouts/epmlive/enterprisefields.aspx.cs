    ...
    public partial class enterprisefields : LayoutsPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!SPContext.Current.Web.CurrentUser.IsSiteAdmin)
                Response.Redirect(serverUrl + "/_layouts/15/accessdenied.aspx");
        ...
        private void fillGrid()
        {
            ...
            SPSecurity.RunWithElevatedPrivileges(delegate()
            {
                ...
                if (Request["d"] != null)
                {
                    ...
                    Response.Redirect(serverUrl + "/_layouts/15/epmlive/enterprisefields.aspx?" + Guid.NewGuid());
                }
        ...
        {
            Response.Redirect(SPContext.Current.Web.Url + "/_layouts/15/settings.aspx");
            //Guid siteGuid = SPContext.Current.Site.ID
            //SPSecurity.RunWithElevatedPrivileges(delegate()
            //{
