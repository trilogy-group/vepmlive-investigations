        ...
        protected void lnkReactivate_Click(object sender, EventArgs e)
        {
            SPSecurity.RunWithElevatedPrivileges(delegate()
            {
                ...
                try
                {
                    ...
                    EventsDerived events = EPMLiveHelperClasses.GetEventsDerivedObject(SPContext.Current.Site.Url);
                    //EventsDerived events = new EventsDerived();
                    //events.Url = SPContext.Current.Site.Url + "/_vti_bin/psi/events.asmx";
                    //events.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                    //events.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(SPContext.Current.Site.Url);
                    //events.EnforceWindowsAuth = true;
                    ...
                    if (ds.EventHandlers.Select("EventId = 53 and name = 'EPMLivePublisher'").Length <= 0)
                    {
                        ...
                        newDs.EventHandlers.AddEventHandlersRow(new Guid("73DBE692-F21D-4129-8E2B-8B1ED4FA00F5"), "EPMLivePublisher", "EPMLiveEnterprise, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5", "EPMLiveEnterprise.OnPublish", 53, "", 10, string.Empty, false, string.Empty);
                    ...
                    {
                        WebSvcEvents.EventHandlersDataSet newDs = new EPMLiveEnterprise.WebSvcEvents.EventHandlersDataSet();
                        newDs.EventHandlers.AddEventHandlersRow(new Guid("8BBBBC25-7E9D-440b-BE1C-78ED667D5D0B"), "EPMLiveStatusing", "EPMLiveEnterprise, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5", "EPMLiveEnterprise.Status", 133, "", 10, string.Empty, false, string.Empty);
                        events.CreateEventHandlerAssociations(newDs);
                    ...
                    {
                        WebSvcEvents.EventHandlersDataSet newDs = new EPMLiveEnterprise.WebSvcEvents.EventHandlersDataSet();
                        newDs.EventHandlers.AddEventHandlersRow(new Guid("B0C1D09C-F1F6-4a6b-858C-529E22B7688C"), "EPMLiveResUpdated", "EPMLiveEnterprise, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5", "EPMLiveEnterprise.ResourceEvents", 95, "", 10, string.Empty, false, string.Empty);
                        events.CreateEventHandlerAssociations(newDs);
                    ...
                    {
                        WebSvcEvents.EventHandlersDataSet newDs = new EPMLiveEnterprise.WebSvcEvents.EventHandlersDataSet();
                        newDs.EventHandlers.AddEventHandlersRow(new Guid("286DE0F8-2042-4c8b-A8F7-3E276150CD9C"), "EPMLiveResCreated", "EPMLiveEnterprise, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5", "EPMLiveEnterprise.ResourceEvents", 89, "", 10, string.Empty, false, string.Empty);
                        events.CreateEventHandlerAssociations(newDs);
                    ...
                    {
                        WebSvcEvents.EventHandlersDataSet newDs = new EPMLiveEnterprise.WebSvcEvents.EventHandlersDataSet();
                        newDs.EventHandlers.AddEventHandlersRow(new Guid("074BCE6F-CF3B-4a94-BCC4-A262B32AE41E"), "EPMLiveResDeleting", "EPMLiveEnterprise, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5", "EPMLiveEnterprise.ResourceEvents", 92, "", 10, string.Empty, false, string.Empty);
                        events.CreateEventHandlerAssociations(newDs);
            ...
            SPSecurity.RunWithElevatedPrivileges(delegate()
            {
                using (SPSite site = SPContext.Current.Site)
                {
                    try
                    {
                        ...
                        //CustomFieldsDerived cf = new CustomFieldsDerived(SPContext.Current.Site.Url + "/_vti_bin/PSI/customfields.asmx");                        
                        ////cf.Url = SPContext.Current.Site.Url + "/_vti_bin/PSI/customfields.asmx";
                        //cf.Credentials = EPMLiveHelperClasses.GetNetworkCredential();
                        //cf.CookieContainer = EPMLiveHelperClasses.GetLogonCookie(SPContext.Current.Site.Url);
                        //cf.EnforceWindowsAuth = true;
                        
                        CustomFieldsDerived cf = EPMLiveHelperClasses.GetCustomFieldsDerivedObject(SPContext.Current.Site.Url);
