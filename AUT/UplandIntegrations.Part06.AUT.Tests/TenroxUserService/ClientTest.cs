...
using Client = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.Client" />)
    ...
    public partial class ClientTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.User) , PropertyAccountExecutive)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.ClientInvoiceOption[]) , PropertyClientInvoiceOptions)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Project[]) , PropertyClientProject)]
