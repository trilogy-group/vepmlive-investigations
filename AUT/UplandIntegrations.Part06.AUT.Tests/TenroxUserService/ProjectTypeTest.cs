...
using ProjectType = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.ProjectType" />)
    ...
    public partial class ProjectTypeTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.ProjectTypeDescription[]) , PropertyProjectTypeDescriptions)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Project[]) , PropertyProjects)]
