...
using BulkDeleteRequest = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.BulkDeleteRequest" />)
    ...
    public partial class BulkDeleteRequestTest : AbstractBaseSetupV3Test
    {
        ...
        {
            // Arrange
            var p_token = this.CreateType<UplandIntegrations.TenroxUserService.UserToken>();
        ...
        public void AUT_BulkDeleteRequest_Constructors_Overloading_Of_1_Explore_Verify_Test()
        {
            ...
            var methodBulkDeleteRequestPrametersTypes = new Type[] { typeof(UplandIntegrations.TenroxUserService.UserToken), typeof(int[]) };
