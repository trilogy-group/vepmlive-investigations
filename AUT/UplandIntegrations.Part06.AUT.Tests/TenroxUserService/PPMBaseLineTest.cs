...
using PPMBaseLine = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.PPMBaseLine" />)
    ...
    public partial class PPMBaseLineTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.PPMBaseLineExpectedCostBenefit[]) , PropertyBaseLineExpectedCostBenefit)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.PPMBaseLineExpectedDuration[]) , PropertyBaseLineExpectedDurations)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.PPMBaseLineTimeHorizon[]) , PropertyBaseLineTimeHorizons)]
