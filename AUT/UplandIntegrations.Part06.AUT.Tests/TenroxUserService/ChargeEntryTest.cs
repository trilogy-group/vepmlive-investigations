...
using ChargeEntry = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.ChargeEntry" />)
    ...
    public partial class ChargeEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Currency) , PropertyClientCurrency)]
        [TestCaseGeneric(typeof(int) , PropertyClientCurrencyId)]
        [TestCaseGeneric(typeof(decimal) , PropertyCostAmountCostCurrency)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Currency) , PropertyCostCurrency)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Currency) , PropertyUserCurrency)]
