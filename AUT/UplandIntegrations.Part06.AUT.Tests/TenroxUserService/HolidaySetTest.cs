...
using HolidaySet = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.HolidaySet" />)
    ...
    public partial class HolidaySetTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Holiday[]) , PropertyHolidays)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Site[]) , PropertySites)]
