...
using Currency = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.Currency" />)
    ...
    public partial class CurrencyTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.ChargeEntry[]) , PropertyChargeEntries)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.ChargeEntry[]) , PropertyClientChargeEntries)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.ChargeEntry[]) , PropertyCostChargeEntries)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.ChargeEntry[]) , PropertyUserChargeEntries)]
