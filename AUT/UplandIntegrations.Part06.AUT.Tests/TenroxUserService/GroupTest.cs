...
using Group = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.Group" />)
    ...
    public partial class GroupTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.User) , PropertyActualGroupManager)]
        [TestCaseGeneric(typeof(int) , PropertyActualManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.User) , PropertyAlternateGroupManager)]
        [TestCaseGeneric(typeof(int) , PropertyAlternateManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.User[]) , PropertyApprovedUsers)]
        [TestCaseGeneric(typeof(System.Nullable<int>) , PropertyDefaultTaskId)]
        [TestCaseGeneric(typeof(string) , PropertyDescription)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.User) , PropertyFunctionalGroupManager)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.User[]) , PropertyFunctionalUsers)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.UserGroup[]) , PropertyResourceGroupUsers)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.User[]) , PropertyResourceUsers)]
