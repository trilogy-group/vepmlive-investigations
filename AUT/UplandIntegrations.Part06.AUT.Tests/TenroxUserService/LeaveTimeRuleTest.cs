...
using LeaveTimeRule = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.LeaveTimeRule" />)
    ...
    public partial class LeaveTimeRuleTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.LeaveTimeRuleSetup) , PropertyLeaveTimeRuleSetup)]
        [TestCaseGeneric(typeof(short) , PropertyProcessSuspendedUsers)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.RuleExecutionHistory[]) , PropertyRuleExecHistory)]
