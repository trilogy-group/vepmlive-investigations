...
using PlanningRole = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.PlanningRole" />)
    ...
    public partial class PlanningRoleTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.UserPlanningRole[]) , PropertyMembers)]
        [TestCaseGeneric(typeof(string) , PropertyName)]
        [TestCaseGeneric(typeof(int) , PropertyResourceGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.RoleCalendar[]) , PropertyRoleAvailabilityCalendars)]
