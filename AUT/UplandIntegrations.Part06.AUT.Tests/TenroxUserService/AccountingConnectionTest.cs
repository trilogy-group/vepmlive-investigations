...
using AccountingConnection = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.AccountingConnection" />)
    ...
    public partial class AccountingConnectionTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Currency) , PropertyTCURRENCY)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Invoice[]) , PropertyTINVOICEs)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.PayableBatch[]) , PropertyTPAYABLEBATCHes)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.PayrollBatch[]) , PropertyTPAYROLLBATCHes)]
