...
using WorkflowTransition = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.WorkflowTransition" />)
    ...
    public partial class WorkflowTransitionTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.ProjectWorkflowTransitionFlag[]) , PropertyProjectWorkflowTransitionFlag)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.WorkflowState) , PropertyWorkflowState)]
