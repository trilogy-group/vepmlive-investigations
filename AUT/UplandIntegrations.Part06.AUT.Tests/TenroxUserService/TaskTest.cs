...
using Task = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.Task" />)
    ...
    public partial class TaskTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Assignment[]) , PropertyAssignment)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.BaseWorkType) , PropertyBaseWorkType)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.MilestoneTask[]) , PropertyMilestoneTask)]
