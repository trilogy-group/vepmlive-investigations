...
using PortfolioAllocatedBudget = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.PortfolioAllocatedBudget" />)
    ...
    public partial class PortfolioAllocatedBudgetTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.PortfolioBudget) , PropertyPortfolioBudget)]
