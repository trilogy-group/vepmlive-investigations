...
using BaseWorkType = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.BaseWorkType" />)
    ...
    public partial class BaseWorkTypeTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.LeaveTimeRuleSetup[]) , PropertyLeaveTime)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.SystemDefault[]) , PropertyTSYSDEFS1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Task[]) , PropertyTask)]
        [TestCaseGeneric(typeof(int) , PropertyUniqueId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.LeaveTimeUserHistory[]) , PropertyUserHistory)]
