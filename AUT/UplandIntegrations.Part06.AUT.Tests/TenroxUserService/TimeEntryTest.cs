...
using TimeEntry = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.TimeEntry" />)
    ...
    public partial class TimeEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.BusinessUnit) , PropertyBusinessUnit)]
        [TestCaseGeneric(typeof(int) , PropertyBusinessUnitId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.ChargeEntry) , PropertyChargeEntry)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Phase) , PropertyTPHASE)]
