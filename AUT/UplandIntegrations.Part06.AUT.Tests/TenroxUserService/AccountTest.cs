...
using Account = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.Account" />)
    ...
    public partial class AccountTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Project[]) , PropertyTPROJECTs)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Project[]) , PropertyTPROJECTs1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Project[]) , PropertyTPROJECTs2)]
