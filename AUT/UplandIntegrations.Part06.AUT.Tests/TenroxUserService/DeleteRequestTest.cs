...
using DeleteRequest = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.DeleteRequest" />)
    ...
    public partial class DeleteRequestTest : AbstractBaseSetupV3Test
    {
        ...
        public void AUT_DeleteRequest_Constructors_Overloading_Of_1_Explore_Verify_Test()
        {
            ...
            var methodDeleteRequestPrametersTypes = new Type[] { typeof(UplandIntegrations.TenroxUserService.UserToken), typeof(int) };
