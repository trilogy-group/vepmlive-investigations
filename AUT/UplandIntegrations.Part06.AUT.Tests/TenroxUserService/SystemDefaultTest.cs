...
using SystemDefault = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.SystemDefault" />)
    ...
    public partial class SystemDefaultTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.ProjectWorkflowMap) , PropertyProjectWorkflow)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.SkillSet) , PropertySkillSet)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.AccountingConnection) , PropertyTACCCONSET)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Charge) , PropertyTCHARGE)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.Charge) , PropertyTCHARGE1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.BaseWorkType) , PropertyTWORKTYPE)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.BaseWorkType) , PropertyTWORKTYPE1)]
