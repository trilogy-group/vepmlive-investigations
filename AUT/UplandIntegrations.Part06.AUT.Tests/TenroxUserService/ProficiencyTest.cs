...
using Proficiency = UplandIntegrations.TenroxUserService;

namespace UplandIntegrations.TenroxUserService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxUserService.Proficiency" />)
    ...
    public partial class ProficiencyTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.BookingSkill[]) , PropertyBookingSkills)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.ProficiencyDescription[]) , PropertyDescriptions)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxUserService.TitleSkill[]) , PropertyTitleSkills)]
