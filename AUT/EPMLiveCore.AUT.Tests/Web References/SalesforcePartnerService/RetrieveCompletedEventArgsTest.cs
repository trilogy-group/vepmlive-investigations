...
using retrieveCompletedEventArgs = EPMLiveCore.SalesforcePartnerService;

namespace EPMLiveCore.SalesforcePartnerService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="EPMLiveCore.SalesforcePartnerService.retrieveCompletedEventArgs" />)
    ...
    public partial class RetrieveCompletedEventArgsTest : AbstractBaseSetupTypedTest<retrieveCompletedEventArgs>
    {
        ...
        #region General Getters/Setters : Class (retrieveCompletedEventArgs) => Property (Result) Property Type Test Except String

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_RetrieveCompletedEventArgs_Result_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            // Arrange
            ...
            Action currentAction = () => propertyInfo.SetValue(_retrieveCompletedEventArgsInstance, randomString, null);
        ...
        #region General Getters/Setters : Class (retrieveCompletedEventArgs) => Property (Result) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_RetrieveCompletedEventArgs_Public_Class_Result_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            var propertyInfo  = GetPropertyInfo(PropertyResult);
