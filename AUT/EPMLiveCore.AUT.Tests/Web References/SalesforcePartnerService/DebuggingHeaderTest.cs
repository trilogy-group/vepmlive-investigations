...
using DebuggingHeader = EPMLiveCore.SalesforcePartnerService;

namespace EPMLiveCore.SalesforcePartnerService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="EPMLiveCore.SalesforcePartnerService.DebuggingHeader" />)
    ...
    public partial class DebuggingHeaderTest : AbstractBaseSetupTypedTest<DebuggingHeader>
    {
        ...
        [TestCaseGeneric(typeof(DebugLevel) , PropertydebugLevel)]
