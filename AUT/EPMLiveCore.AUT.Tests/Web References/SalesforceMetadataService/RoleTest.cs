...
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="EPMLiveCore.SalesforceMetadataService.Role" />)
    ...
    public partial class RoleTest : AbstractBaseSetupTypedTest<Role>
    {
        ...
        private const string PropertyparentRole = "parentRole";
        private const string FieldparentRoleField = "parentRoleField";
        ...
        [TestCaseGeneric(typeof(string) , PropertyparentRole)]
        ...
        #region General Getters/Setters : Class (Role) => Property (parentRole) (Can Read) tests

        [Test]
        [Timeout(TestsTimeOut)]
        [NUnit.Framework.Category("AUT GetterSetter")]
        public void AUT_Role_Public_Class_parentRole_Coverage_For_Property_Is_Present_And_Can_Read_Test()
        {
            // Arrange
            var propertyInfo  = GetPropertyInfo(PropertyparentRole);
