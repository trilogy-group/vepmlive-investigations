...
using GetItemTypeCompletedEventArgs = EPMLiveCore.SSRS2006;

namespace EPMLiveCore.SSRS2006
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="EPMLiveCore.SSRS2006.GetItemTypeCompletedEventArgs" />)
    ///     and namespace <see cref="EPMLiveCore.SSRS2006"/> class using generator(v:0.2.1)'s 
    ///     artificial intelligence.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class GetItemTypeCompletedEventArgsTest : AbstractBaseSetupTypedTest<GetItemTypeCompletedEventArgs>
    {
        ...
        public void OneTimeSetup()
        {
            ...
            _getItemTypeCompletedEventArgsInstanceFixture = Create(true);
            _getItemTypeCompletedEventArgsInstance = Create(false);
        }
        ...
        public void AUT_GetItemTypeCompletedEventArgs_All_Properties_Explore_Verify_By_Name_Test(string name)
        {
            ...
            // Act
            ShouldlyExtension.ExploreProperty(_getItemTypeCompletedEventArgsInstanceFixture,
                                              Fixture,
                                              propertyInfo);
        ...
        public void AUT_GetItemTypeCompletedEventArgs_All_Fields_Explore_Verify_By_Name_Test(string name)
        {
            ...
            // Act
            ShouldlyExtension.ExploreFieldWithOrWithoutInstance(_getItemTypeCompletedEventArgsInstanceFixture, 
                                                                Fixture, 
                                                                fieldInfo);
