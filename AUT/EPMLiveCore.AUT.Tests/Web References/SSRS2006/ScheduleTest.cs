...
using Schedule = EPMLiveCore.SSRS2006;

namespace EPMLiveCore.SSRS2006
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="EPMLiveCore.SSRS2006.Schedule" />)
    ...
    public partial class ScheduleTest : AbstractBaseSetupTypedTest<Schedule>
    {
        ...
        [TestCaseGeneric(typeof(ScheduleStateEnum) , PropertyState)]
