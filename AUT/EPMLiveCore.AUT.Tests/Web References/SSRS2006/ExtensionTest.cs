...
using Extension = EPMLiveCore.SSRS2006;

namespace EPMLiveCore.SSRS2006
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="EPMLiveCore.SSRS2006.Extension" />)
    ...
    public partial class ExtensionTest : AbstractBaseSetupTypedTest<Extension>
    {
        ...
        [TestCaseGeneric(typeof(ExtensionTypeEnum) , PropertyExtensionType)]
        ...
        public void AUT_Extension_ExtensionType_Property_Setting_String_Throw_Argument_Exception_Test()
        {
            ...
            // Act
            var propertyInfo = GetPropertyInfo(PropertyExtensionType);
