...
using GetReportDefinitionCompletedEventArgs = EPMLiveCore.SSRS2005;

namespace EPMLiveCore.SSRS2005
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="EPMLiveCore.SSRS2005.GetReportDefinitionCompletedEventArgs" />)
    ///     and namespace <see cref="EPMLiveCore.SSRS2005"/> class using generator(v:0.2.1)'s 
    ///     artificial intelligence.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class GetReportDefinitionCompletedEventArgsTest : AbstractBaseSetupTypedTest<GetReportDefinitionCompletedEventArgs>
    {
        ...
        public void OneTimeSetup()
        {
            ...
            _getReportDefinitionCompletedEventArgsInstanceFixture = Create(true);
            _getReportDefinitionCompletedEventArgsInstance = Create(false);
        }
        ...
        public void AUT_GetReportDefinitionCompletedEventArgs_All_Properties_Explore_Verify_By_Name_Test(string name)
        {
            ...
            // Act
            ShouldlyExtension.ExploreProperty(_getReportDefinitionCompletedEventArgsInstanceFixture,
                                              Fixture,
                                              propertyInfo);
        ...
        public void AUT_GetReportDefinitionCompletedEventArgs_All_Fields_Explore_Verify_By_Name_Test(string name)
        {
            ...
            // Act
            ShouldlyExtension.ExploreFieldWithOrWithoutInstance(_getReportDefinitionCompletedEventArgsInstanceFixture, 
                                                                Fixture, 
                                                                fieldInfo);
