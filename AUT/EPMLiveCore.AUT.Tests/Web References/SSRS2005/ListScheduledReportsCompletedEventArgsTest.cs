...
using ListScheduledReportsCompletedEventArgs = EPMLiveCore.SSRS2005;

namespace EPMLiveCore.SSRS2005
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="EPMLiveCore.SSRS2005.ListScheduledReportsCompletedEventArgs" />)
    ///     and namespace <see cref="EPMLiveCore.SSRS2005"/> class using generator(v:0.2.1)'s 
    ///     artificial intelligence.
    /// </summary>
    [TestFixture]
    [ExcludeFromCodeCoverage]
    public partial class ListScheduledReportsCompletedEventArgsTest : AbstractBaseSetupTypedTest<ListScheduledReportsCompletedEventArgs>
    {
        ...
        public void OneTimeSetup()
        {
            ...
            _listScheduledReportsCompletedEventArgsInstanceFixture = Create(true);
            _listScheduledReportsCompletedEventArgsInstance = Create(false);
        }
        ...
        public void AUT_ListScheduledReportsCompletedEventArgs_All_Properties_Explore_Verify_By_Name_Test(string name)
        {
            ...
            // Act
            ShouldlyExtension.ExploreProperty(_listScheduledReportsCompletedEventArgsInstanceFixture,
                                              Fixture,
                                              propertyInfo);
        ...
        public void AUT_ListScheduledReportsCompletedEventArgs_All_Fields_Explore_Verify_By_Name_Test(string name)
        {
            ...
            // Act
            ShouldlyExtension.ExploreFieldWithOrWithoutInstance(_listScheduledReportsCompletedEventArgsInstanceFixture, 
                                                                Fixture, 
                                                                fieldInfo);
