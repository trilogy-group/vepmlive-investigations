...
namespace EPMLiveCore.ReportingProxy
{
    ...
    public class QueryExecutorTest : AbstractBaseSetupTypedTest<QueryExecutor>
    {
        ...
        /// <summary>
        ///     Class (<see cref="QueryExecutor" />) can be created test
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_QueryExecutor_Is_Instance_Present_Test()
        {
            // Assert
            _queryExecutorInstanceType.ShouldNotBeNull();
            _queryExecutorInstance.ShouldNotBeNull();
            _queryExecutorInstanceFixture.ShouldNotBeNull();
            _queryExecutorInstance.ShouldBeAssignableTo<QueryExecutor>();
            _queryExecutorInstanceFixture.ShouldBeAssignableTo<QueryExecutor>();
        }
        ...
        #region General Constructor : Class (QueryExecutor) with Parameter Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_QueryExecutor_Constructor_With_Parameter_Created_Instance_Type_Test()
        {
            // Arrange
            var spWeb = CreateType<SPWeb>();
            QueryExecutor instance = null;
            Exception creationException = null;

            // Act
            Action createAction = () => instance = new QueryExecutor(spWeb);
            ...
            _queryExecutorInstance.ShouldNotBeNull();
            _queryExecutorInstanceFixture.ShouldNotBeNull();
            instance.ShouldBeOfType<QueryExecutor>();
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_QueryExecutor_Constructor_Instantiation_With_Parameter_Test()
        {
            // Arrange
            var spWeb = CreateType<SPWeb>();
            QueryExecutor instance = null;
