...
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="EPMLiveCore.Integrations.Salesforce.Integrator" />)
    ///     and namespace <see cref="EPMLiveCore.Integrations.Salesforce"/> class using generator(v:0.2.1)'s 
    ...
    public class IntegratorTest : AbstractBaseSetupTypedTest<Integrator>
    {
        ...
        private const string MethodGetSfService = "GetSfService";
        ...
        public void AUT_Integrator_PullData_Method_DirectCall_Throw_Exception_Test()
        {
            ...
            // Act
            executeAction = () => _integratorInstance.PullData(webProps, log, items, lastSynch);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_TestConnection_Method_DirectCall_No_Exception_Thrown_Test()
        {
            // Arrange
            var webProps = CreateType<WebProperties>();
            var log = CreateType<IntegrationLog>();
        ...
        #region Method Call : (TestConnection) (Return Type : bool) No Exception Thrown

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_TestConnection_Method_Call_With_No_Exception_Thrown_Test()
        {
            // Arrange
            var webProps = CreateType<WebProperties>();
            var log = CreateType<IntegrationLog>();
            ...
            parametersOfTestConnection.Length.ShouldBe(3);
            methodTestConnectionPrametersTypes.Length.ShouldBe(3);
            Should.NotThrow(() => methodInfo.Invoke(_integratorInstanceFixture, parametersOfTestConnection));
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_TestConnection_Method_Call_Dynamic_Invoking_Without_Parameters_Results_Should_Not_Be_Null_Test()
        {
            // Arrange
            Exception exception;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetAuthParameters_Static_Method_Call_Void_With_5_Parameters_Throw_Exception_Thrown_Test()
        {
            // Arrange
            var webProps = CreateType<WebProperties>();
            var username = CreateType<string>();
            var password = CreateType<string>();
            var securityToken = CreateType<string>();
            var isSandbox = CreateType<bool>();
            var methodGetAuthParametersPrametersTypes = new Type[] { typeof(WebProperties), typeof(string), typeof(string), typeof(string), typeof(bool) };
            object[] parametersOfGetAuthParameters = { webProps, username, password, securityToken, isSandbox };
            Exception exception = null;
            ...
            parametersOfGetAuthParameters.Length.ShouldBe(5);
            methodGetAuthParametersPrametersTypes.Length.ShouldBe(5);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetAuthParameters_Static_Method_Call_Void_With_5_Parameters_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            var webProps = CreateType<WebProperties>();
            var username = CreateType<string>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetAuthParameters_Static_Method_Call_With_5_Parameters_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            Exception exception;
            var methodInfo = GetMethodInfo(MethodGetAuthParameters, 0);
        ...
        public void AUT_Integrator_GetMatchingListColumn_Method_Call_With_No_Exception_Thrown_Test()
        {
            ...
            var appNamespace = CreateType<string>();
            var methodGetMatchingListColumnPrametersTypes = new Type[] { typeof(string), typeof(string), typeof(string) };
            object[] parametersOfGetMatchingListColumn = { displayName, internalName, appNamespace };
            Exception exception = null;
            ...
            parametersOfGetMatchingListColumn.Length.ShouldBe(3);
            methodGetMatchingListColumnPrametersTypes.Length.ShouldBe(3);
        ...
        #region Method Call : (GetSfService) (Return Type : SfService) private call definition

        [ExcludeFromCodeCoverage]
        private void AUT_Integrator_GetSfService_Static_Method_Call_Internally(Type[] types)
        {
            var methodGetSfServicePrametersTypes = types;
            ReflectionAnalyzer.InvokeStaticMethodWithDynamicParameters(_integratorInstanceFixture, _integratorInstanceType, MethodGetSfService, Fixture, methodGetSfServicePrametersTypes);
        }

        #endregion

        #region Method Call : (GetSfService) (Return Type : SfService) Results Null (if not primitive type) Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetSfService_Static_Method_Call_With_Call_Results_ShouldBe_Null_If_Not_Premitive_Type_Test()
        {
            // Arrange
            var webProps = CreateType<WebProperties>();
            var methodGetSfServicePrametersTypes = new Type[] { typeof(WebProperties) };
            object[] parametersOfGetSfService = { webProps };
            Exception exception, exception1;
            var methodInfo = GetMethodInfo(MethodGetSfService, methodGetSfServicePrametersTypes, out exception);

            // Act
            var result1 = ReflectionAnalyzer.InvokeStaticMethodWithDynamicParameters(_integratorInstanceFixture, _integratorInstanceType, MethodGetSfService, Fixture, methodGetSfServicePrametersTypes);
            var result2 = ReflectionAnalyzer.GetResultOfStaticMethod<SPService>(_integratorInstanceFixture, _integratorInstanceType, MethodGetSfService, parametersOfGetSfService, methodGetSfServicePrametersTypes);
            Action currentAction = () => methodInfo.Invoke(_integratorInstanceFixture, parametersOfGetSfService);
            ...
            result1.ShouldBeNull();
            result2.ShouldBeNull();
            parametersOfGetSfService.ShouldNotBeNull();
            parametersOfGetSfService.Length.ShouldBe(1);
            methodGetSfServicePrametersTypes.Length.ShouldBe(1);
            Should.Throw<Exception>(currentAction);
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetSfService_Static_Method_Call_Dynamic_Invoking_Results_Null_If_Not_Primitive_Type_Test()
        {
            // Arrange
            var methodGetSfServicePrametersTypes = new Type[] { typeof(WebProperties) };

            // Act
            var result = ReflectionAnalyzer.InvokeStaticMethodWithDynamicParameters(_integratorInstanceFixture, _integratorInstanceType, MethodGetSfService, Fixture, methodGetSfServicePrametersTypes);
        ...
        #region Method Call : (GetSfService) (Return Type : SfService) Invoke Should Not Throw

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetSfService_Static_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            var methodGetSfServicePrametersTypes = new Type[] { typeof(WebProperties) };
            ...
            // Act
            Action currentAction = () => ReflectionAnalyzer.InvokeStaticMethodWithDynamicParameters(_integratorInstanceFixture, _integratorInstanceType, MethodGetSfService, Fixture, methodGetSfServicePrametersTypes);

            // Assert
            Should.NotThrow(currentAction);
            methodGetSfServicePrametersTypes.Length.ShouldBe(parametersCount);
        }

        #endregion

        #region Method Call : (GetSfService) (Return Type : SfService) without parameters value verify result should be null.

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetSfService_Static_Method_Call_Dynamic_Invoking_Without_Parameters_Results_Should_Be_Null_Test()
        {
            // Arrange
            Exception exception;
            var methodInfo = GetMethodInfo(MethodGetSfService, 0);
        ...
        #region Method Call : (GetSfService) (Return Type : SfService) Parameters Count verify

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetSfService_Static_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            var methodInfo = GetMethodInfo(MethodGetSfService, 0);
            const int parametersCount = 1;
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_Integrator_TranslateFieldType_Static_Method_Call_Internally(Type[] types)
        {
            var methodTranslateFieldTypePrametersTypes = types;
            ReflectionAnalyzer.InvokeStaticMethodWithDynamicParameters(_integratorInstanceFixture, _integratorInstanceType, MethodTranslateFieldType, Fixture, methodTranslateFieldTypePrametersTypes);
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_TranslateFieldType_Static_Method_Call_With_No_Exception_Thrown_Test()
        {
            // Arrange
            var type = CreateType<fieldType>();
            var methodTranslateFieldTypePrametersTypes = new Type[] { typeof(fieldType) };
            object[] parametersOfTranslateFieldType = { type };
            Exception exception = null;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_TranslateFieldType_Static_Method_Call_With_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            var type = CreateType<fieldType>();
            var methodTranslateFieldTypePrametersTypes = new Type[] { typeof(fieldType) };
            ...
            parametersOfTranslateFieldType.Length.ShouldBe(1);
            methodTranslateFieldTypePrametersTypes.Length.ShouldBe(1);
            Should.NotThrow(() => ReflectionAnalyzer.GetResultOfStaticMethod<Type>(_integratorInstanceFixture, _integratorInstanceType, MethodTranslateFieldType, parametersOfTranslateFieldType, methodTranslateFieldTypePrametersTypes));
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_TranslateFieldType_Static_Method_Call_Dynamic_Invoking_Results_Null_If_Not_Primitive_Type_Test()
        {
            // Arrange
            var methodTranslateFieldTypePrametersTypes = new Type[] { typeof(fieldType) };

            // Act
            var result = ReflectionAnalyzer.InvokeStaticMethodWithDynamicParameters(_integratorInstanceFixture, _integratorInstanceType, MethodTranslateFieldType, Fixture, methodTranslateFieldTypePrametersTypes);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_TranslateFieldType_Static_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            var methodTranslateFieldTypePrametersTypes = new Type[] { typeof(fieldType) };
            const int parametersCount = 1;
            ...
            // Act
            Action currentAction = () => ReflectionAnalyzer.InvokeStaticMethodWithDynamicParameters(_integratorInstanceFixture, _integratorInstanceType, MethodTranslateFieldType, Fixture, methodTranslateFieldTypePrametersTypes);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_TranslateFieldType_Static_Method_Call_Dynamic_Invoking_Without_Parameters_Results_Should_Not_Be_Null_Test()
        {
            // Arrange
            Exception exception;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_TranslateFieldType_Static_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            var methodInfo = GetMethodInfo(MethodTranslateFieldType, 0);
            const int parametersCount = 1;
