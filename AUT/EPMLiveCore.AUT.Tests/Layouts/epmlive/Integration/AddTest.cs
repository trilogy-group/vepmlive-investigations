...
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="EPMLiveCore.Layouts.epmlive.Integration.Add" />)
    ...
    public partial class AddTest : AbstractBaseSetupTypedTest<Add>
    {
        ...
        private const string FieldIntegrations = "Integrations";
        ...
        #region General Initializer : Class (Add) All Fields Explore By Name
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Initializer")]
        [TestCase(FieldIntegrations)]
        public void AUT_Add_All_Fields_Explore_Verify_By_Name_Test(string name)
        {
            // Arrange
            var fieldInfo = GetFieldInfo(name);

            // Act
            ShouldlyExtension.ExploreFieldWithOrWithoutInstance(_addInstanceFixture, 
                                                                Fixture, 
                                                                fieldInfo);
