...
namespace EPMLiveCore
{
    ...
    public class ListDisplayPageTest : AbstractBaseSetupTypedTest<ListDisplayPage>
    {
        ...
        private const string FieldpageRender = "_pageRender";
        private const string FieldcurrentList = "_currentList";
        private const string FielddisplayableFields = "_displayableFields";
        private const string Fieldgroups = "_groups";
        private const string FieldcomputeFieldsScript = "_computeFieldsScript";
        private const string FieldfieldProperties = "_fieldProperties";
        private const string FieldOK = "OK";
        private const string FieldCancel = "Cancel";
        private const string FieldPAGE_SIZE = "PageSize";
