...
namespace EPMLiveCore.TagManager
{
    ...
    public class TagManagerTest : AbstractBaseSetupTypedTest<TagManager>
    {
        ...
        /// <summary>
        ///     Class (<see cref="TagManager" />) can be created test
        /// </summary>
        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Instance")]
        public void AUT_TagManager_Is_Instance_Present_Test()
        {
            // Assert
            _tagManagerInstanceType.ShouldNotBeNull();
            _tagManagerInstance.ShouldNotBeNull();
            _tagManagerInstanceFixture.ShouldNotBeNull();
            _tagManagerInstance.ShouldBeAssignableTo<TagManager>();
            _tagManagerInstanceFixture.ShouldBeAssignableTo<TagManager>();
        }
        ...
        #region General Constructor : Class (TagManager) with Parameter Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_TagManager_Constructor_With_Parameter_Created_Instance_Type_Test()
        {
            // Arrange
            ...
            // Act
            Action createAction = () => instance = new TagManager(spWeb);
            ...
            _tagManagerInstance.ShouldNotBeNull();
            _tagManagerInstanceFixture.ShouldNotBeNull();
            instance.ShouldBeOfType<TagManager>();
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Constructor")]
        public void AUT_TagManager_Constructor_Instantiation_With_Parameter_Test()
        {
            // Arrange
            var spWeb = CreateType<SPWeb>();
            TagManager instance = null;
