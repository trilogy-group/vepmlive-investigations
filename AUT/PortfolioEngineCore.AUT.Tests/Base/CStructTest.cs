...
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="PortfolioEngineCore.CStruct" />)
    ...
    public class CStructTest : AbstractBaseSetupTypedTest<CStruct>
    {
        ...
        private const string MethodSetBooleanAttr = "SetBooleanAttr";
        private const string MethodSetStringAttr = "SetStringAttr";
        private const string MethodSetIntAttr = "SetIntAttr";
        ...
        [TestCase(MethodGetBooleanAttr, 2)]
        ...
        [TestCase(MethodSetBooleanAttr, 0)]
        [TestCase(MethodSetStringAttr, 0)]
        [TestCase(MethodSetIntAttr, 0)]
        ...
        [TestCase(MethodSetBooleanAttr)]
        [TestCase(MethodSetStringAttr)]
        [TestCase(MethodSetIntAttr)]
        ...
        [ExcludeFromCodeCoverage]
        private void AUT_CStruct_GetBooleanAttr_Method_Overloading_Of_2_Call_Internally(Type[] types)
        {
            var methodGetBooleanAttrPrametersTypes = types;
            ReflectionAnalyzer.InvokeNonStaticMethodWithDynamicParameters(_cStructInstance, MethodGetBooleanAttr, Fixture, methodGetBooleanAttrPrametersTypes);
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_GetBooleanAttr_Method_DirectCall_Overloading_Of_2_Throw_Exception_Test()
        {
            // Arrange
            var sItemName = CreateType<string>();
            ...
            // Act
            executeAction = () => _cStructInstance.GetBooleanAttr(sItemName, out bTagFound);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_GetBooleanAttr_Method_Call_Overloading_Of_2_With_No_Parameters_Call_Results_ShouldBe_Null_If_Not_Premitive_Type_Test()
        {
            // Arrange
            var sItemName = CreateType<string>();
            var bTagFound = CreateType<bool>();
            var methodGetBooleanAttrPrametersTypes = new Type[] { typeof(string), typeof(bool) };
            object[] parametersOfGetBooleanAttr = { sItemName, bTagFound };
            Exception exception, exception1;
            var methodInfo = GetMethodInfo(MethodGetBooleanAttr, methodGetBooleanAttrPrametersTypes, out exception);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_GetBooleanAttr_Method_Call_Overloading_Of_2_With_Results_Should_Not_Be_Null_Test()
        {
            // Arrange
            var sItemName = CreateType<string>();
            var bTagFound = CreateType<bool>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_GetBooleanAttr_Method_Call_Overloading_Of_2_With_Call_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            var sItemName = CreateType<string>();
            var bTagFound = CreateType<bool>();
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_GetBooleanAttr_Method_Call_Overloading_Of_2_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            var methodGetBooleanAttrPrametersTypes = new Type[] { typeof(string), typeof(bool) };
            const int parametersCount = 2;
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_GetBooleanAttr_Method_Call_Overloading_Of_2_Dynamic_Invoking_Without_Parameters_Results_Should_Be_Null_Test()
        {
            // Arrange
            Exception exception;
            var methodInfo = GetMethodInfo(MethodGetBooleanAttr, 2);
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_GetBooleanAttr_Method_Call_Overloading_Of_2_Parameters_Count_Verification_Test()
        {
            // Arrange
            var methodInfo = GetMethodInfo(MethodGetBooleanAttr, 2);
            const int parametersCount = 2;
        ...
        #region Method Call : (SetBooleanAttr) (Return Type : void) private call definition

        [ExcludeFromCodeCoverage]
        private void AUT_CStruct_SetBooleanAttr_Method_Call_Internally(Type[] types)
        {
            var methodSetBooleanAttrPrametersTypes = types;
            ReflectionAnalyzer.InvokeNonStaticMethodWithDynamicParameters(_cStructInstance, MethodSetBooleanAttr, Fixture, methodSetBooleanAttrPrametersTypes);
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetBooleanAttr_Method_Call_Void_With_3_Parameters_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            var sItemName = CreateType<string>();
            var bValue = CreateType<bool>();
            ...
            // Act
            Action currentAction = () => ReflectionAnalyzer.InvokeVoidMethod(_cStructInstance, MethodSetBooleanAttr, parametersOfSetBooleanAttr, methodSetBooleanAttrPrametersTypes);
        ...
        #region Method Call : (SetBooleanAttr) (Return Type : void) Parameters Count verify

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetBooleanAttr_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            var methodInfo = GetMethodInfo(MethodSetBooleanAttr, 0);
            const int parametersCount = 3;
        ...
        #region Method Call : (SetBooleanAttr) (Return Type : void) Invoke Should Not Throw

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetBooleanAttr_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            var methodSetBooleanAttrPrametersTypes = new Type[] { typeof(string), typeof(bool), typeof(bool) };

            // Act
            Action currentAction = () => ReflectionAnalyzer.InvokeNonStaticMethodWithDynamicParameters(_cStructInstance, MethodSetBooleanAttr, Fixture, methodSetBooleanAttrPrametersTypes);
        ...
        #region Method Call : (SetBooleanAttr) (Return Type : void) Invoke without parameter types and should not throw

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetBooleanAttr_Method_Call_With_3_Parameters_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            Exception exception;
            var methodInfo = GetMethodInfo(MethodSetBooleanAttr, 0);
        ...
        #region Method Call : (SetStringAttr) (Return Type : void) private call definition

        [ExcludeFromCodeCoverage]
        private void AUT_CStruct_SetStringAttr_Method_Call_Internally(Type[] types)
        {
            var methodSetStringAttrPrametersTypes = types;
            ReflectionAnalyzer.InvokeNonStaticMethodWithDynamicParameters(_cStructInstance, MethodSetStringAttr, Fixture, methodSetStringAttrPrametersTypes);
        }
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetStringAttr_Method_Call_Void_With_3_Parameters_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            var sItemName = CreateType<string>();
            var sValue = CreateType<string>();
            ...
            // Act
            Action currentAction = () => ReflectionAnalyzer.InvokeVoidMethod(_cStructInstance, MethodSetStringAttr, parametersOfSetStringAttr, methodSetStringAttrPrametersTypes);
        ...
        #region Method Call : (SetStringAttr) (Return Type : void) Parameters Count verify

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetStringAttr_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            var methodInfo = GetMethodInfo(MethodSetStringAttr, 0);
            const int parametersCount = 3;
        ...
        #region Method Call : (SetStringAttr) (Return Type : void) Invoke Should Not Throw

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetStringAttr_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            var methodSetStringAttrPrametersTypes = new Type[] { typeof(string), typeof(string), typeof(bool) };

            // Act
            Action currentAction = () => ReflectionAnalyzer.InvokeNonStaticMethodWithDynamicParameters(_cStructInstance, MethodSetStringAttr, Fixture, methodSetStringAttrPrametersTypes);
        ...
        #region Method Call : (SetStringAttr) (Return Type : void) Invoke without parameter types and should not throw

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetStringAttr_Method_Call_With_3_Parameters_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            Exception exception;
            var methodInfo = GetMethodInfo(MethodSetStringAttr, 0);
        ...
        #region Method Call : (SetIntAttr) (Return Type : void) private call definition

        [ExcludeFromCodeCoverage]
        private void AUT_CStruct_SetIntAttr_Method_Call_Internally(Type[] types)
        {
        ...
        #region Method Call : (SetIntAttr) (Return Type : void) No Exception with encapsulation Thrown

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetIntAttr_Method_Call_Void_With_3_Parameters_No_Exception_Thrown_With_Encapsulation_Test()
        {
            // Arrange
            var sItemName = CreateType<string>();
            var nValue = CreateType<int>();
            ...
            // Act
            Action currentAction = () => ReflectionAnalyzer.InvokeVoidMethod(_cStructInstance, MethodSetIntAttr, parametersOfSetIntAttr, methodSetIntAttrPrametersTypes);
        ...
        #region Method Call : (SetIntAttr) (Return Type : void) Parameters Count verify

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetIntAttr_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            var methodInfo = GetMethodInfo(MethodSetIntAttr, 0);
            const int parametersCount = 3;
        ...
        #region Method Call : (SetIntAttr) (Return Type : void) Invoke Should Not Throw

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetIntAttr_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            var methodSetIntAttrPrametersTypes = new Type[] { typeof(string), typeof(int), typeof(bool) };

            // Act
            Action currentAction = () => ReflectionAnalyzer.InvokeNonStaticMethodWithDynamicParameters(_cStructInstance, MethodSetIntAttr, Fixture, methodSetIntAttrPrametersTypes);
        ...
        #region Method Call : (SetIntAttr) (Return Type : void) Invoke without parameter types and should not throw

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_CStruct_SetIntAttr_Method_Call_With_3_Parameters_Dynamic_Invoking_Without_Parameters_Should_Not_Throw_Test()
        {
            // Arrange
            Exception exception;
            var methodInfo = GetMethodInfo(MethodSetIntAttr, 0);
