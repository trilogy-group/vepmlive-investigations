...
using Assignment = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.Assignment" />)
    ...
    public partial class AssignmentTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.TPPAssignmentChangeRequest[]) , PropertyTPLNASGNCHANGEREQUEST)]
