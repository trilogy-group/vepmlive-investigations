...
using PortfolioAllocatedBudget = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.PortfolioAllocatedBudget" />)
    ...
    public partial class PortfolioAllocatedBudgetTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PortfolioBudget) , PropertyPortfolioBudget)]
