...
using Project = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.Project" />)
    ...
    public partial class ProjectTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User) , PropertyActualManager)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User) , PropertyAlternateManager)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Project[]) , PropertyChildren)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Client) , PropertyClient)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMProjectDependency[]) , PropertyDependentProjects)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User) , PropertyManager)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMBaseLine[]) , PropertyPPBBaseLines)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMExpectedCostBenefit[]) , PropertyPPMExpectedCostBenefits)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMExpectedDuration[]) , PropertyPPMExpectedDurations)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMGoal[]) , PropertyPPMGoals)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMProjectDependency[]) , PropertyPPMProjectDependencies)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMResourceAllocation[]) , PropertyPPMResourceAllocations)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMSponsor[]) , PropertyPPMSponsors)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMTimeHorizon[]) , PropertyPPMTimeHorizons)]
        [TestCaseGeneric(typeof(int) , PropertyPROJECTCONTACTID)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Project) , PropertyParent)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Portfolio) , PropertyPortfolio)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PortfolioAllocatedBudget[]) , PropertyPortfolioAllocatedBudgets)]
        [TestCaseGeneric(typeof(int) , PropertyPortfolioId)]
        [TestCaseGeneric(typeof(string) , PropertyPriority)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ProjectRevenueRecognitionPreference) , PropertyProjectRevenueRecognitionPreference)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ProjectType) , PropertyProjectType)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Account) , PropertyTACCOUNT)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Account) , PropertyTACCOUNT1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Account) , PropertyTACCOUNT2)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Milestone[]) , PropertyTMILEST)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Task[]) , PropertyTask)]
