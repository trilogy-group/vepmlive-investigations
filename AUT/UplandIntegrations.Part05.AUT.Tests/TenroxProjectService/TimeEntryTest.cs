...
using TimeEntry = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.TimeEntry" />)
    ...
    public partial class TimeEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.BusinessUnit) , PropertyBusinessUnit)]
        [TestCaseGeneric(typeof(int) , PropertyBusinessUnitId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ChargeEntry) , PropertyChargeEntry)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Site) , PropertySite)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Phase) , PropertyTPHASE)]
