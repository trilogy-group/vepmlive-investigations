...
using HolidaySet = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.HolidaySet" />)
    ...
    public partial class HolidaySetTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Holiday[]) , PropertyHolidays)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Site[]) , PropertySites)]
