...
using LeaveTimeRule = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.LeaveTimeRule" />)
    ...
    public partial class LeaveTimeRuleTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.LeaveTimeRuleSetup) , PropertyLeaveTimeRuleSetup)]
        [TestCaseGeneric(typeof(short) , PropertyProcessSuspendedUsers)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.RuleExecutionHistory[]) , PropertyRuleExecHistory)]
