...
using TitleSkill = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.TitleSkill" />)
    ...
    public partial class TitleSkillTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Proficiency) , PropertyProficiency)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Skill) , PropertySkill)]
