...
using WorkflowEntry = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.WorkflowEntry" />)
    ...
    public partial class WorkflowEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMRiskAssociation[]) , PropertyPPMRiskAssociation)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.TimeEntry[]) , PropertyTimeEntry)]
