...
using BusinessUnit = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.BusinessUnit" />)
    ...
    public partial class BusinessUnitTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User) , PropertyManagedBy)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.UsersBusinessUnits[]) , PropertyUsersBusinessUnits)]
