...
using Group = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.Group" />)
    ...
    public partial class GroupTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User) , PropertyActualGroupManager)]
        [TestCaseGeneric(typeof(int) , PropertyActualManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User) , PropertyAlternateGroupManager)]
        [TestCaseGeneric(typeof(int) , PropertyAlternateManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User[]) , PropertyApprovedUsers)]
        [TestCaseGeneric(typeof(System.Nullable<int>) , PropertyDefaultTaskId)]
        [TestCaseGeneric(typeof(string) , PropertyDescription)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User) , PropertyFunctionalGroupManager)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User[]) , PropertyFunctionalUsers)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.UserGroup[]) , PropertyResourceGroupUsers)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User[]) , PropertyResourceUsers)]
