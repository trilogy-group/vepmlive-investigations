...
using Task = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.Task" />)
    ...
    public partial class TaskTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Assignment[]) , PropertyAssignment)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.BaseWorkType) , PropertyBaseWorkType)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.MilestoneTask[]) , PropertyMilestoneTask)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.TimeEntry[]) , PropertyTimeEntries)]
