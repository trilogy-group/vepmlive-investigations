...
using Milestone = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.Milestone" />)
    ...
    public partial class MilestoneTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Charge) , PropertyCharge)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ChargeEntry[]) , PropertyTCHARGEENTRies)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.BaseWorkType) , PropertyWorktype)]
