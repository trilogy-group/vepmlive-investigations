...
using PPMBaseLine = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.PPMBaseLine" />)
    ...
    public partial class PPMBaseLineTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMBaseLineExpectedCostBenefit[]) , PropertyBaseLineExpectedCostBenefit)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMBaseLineExpectedDuration[]) , PropertyBaseLineExpectedDurations)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMBaseLineTimeHorizon[]) , PropertyBaseLineTimeHorizons)]
