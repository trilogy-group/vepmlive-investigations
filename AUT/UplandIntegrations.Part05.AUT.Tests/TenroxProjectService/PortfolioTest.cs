...
using Portfolio = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.Portfolio" />)
    ...
    public partial class PortfolioTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PortfolioBudget[]) , PropertyBudgets)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ProjectWorkflowMap) , PropertyProjectWorkflowMap)]
