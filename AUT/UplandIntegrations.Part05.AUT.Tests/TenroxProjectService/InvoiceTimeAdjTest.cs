...
using InvoiceTimeAdj = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.InvoiceTimeAdj" />)
    ...
    public partial class InvoiceTimeAdjTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.InvoiceTimEntry) , PropertyInvoiceTimEntry)]
