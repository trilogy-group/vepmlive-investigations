...
using ProjectWorkflowMap = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.ProjectWorkflowMap" />)
    ...
    public partial class ProjectWorkflowMapTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ProjectWorkflowOption[]) , PropertyProjectWorkflowOption)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.EntityKey) , PropertySystemDataObjectsDataClassesIEntityWithKeyEntityKey1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.SystemDefault[]) , PropertySystemDefault)]
