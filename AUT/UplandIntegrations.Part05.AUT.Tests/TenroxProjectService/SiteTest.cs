...
using Site = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.Site" />)
    ...
    public partial class SiteTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User[]) , PropertyActiveSiteUsers)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User[]) , PropertyMasterSiteUsers)]
