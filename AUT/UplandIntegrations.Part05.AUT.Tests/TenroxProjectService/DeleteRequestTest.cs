...
using DeleteRequest = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.DeleteRequest" />)
    ...
    public partial class DeleteRequestTest : AbstractBaseSetupV3Test
    {
        ...
        public void AUT_DeleteRequest_Constructors_Overloading_Of_1_Explore_Verify_Test()
        {
            ...
            var methodDeleteRequestPrametersTypes = new Type[] { typeof(UplandIntegrations.TenroxProjectService.UserToken), typeof(int) };
