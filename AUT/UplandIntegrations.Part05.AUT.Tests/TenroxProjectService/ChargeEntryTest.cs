...
using ChargeEntry = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.ChargeEntry" />)
    ...
    public partial class ChargeEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Currency) , PropertyClientCurrency)]
        [TestCaseGeneric(typeof(int) , PropertyClientCurrencyId)]
        [TestCaseGeneric(typeof(decimal) , PropertyCostAmountCostCurrency)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Currency) , PropertyCostCurrency)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Currency) , PropertyCurrency)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Currency) , PropertyUserCurrency)]
