...
using User = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.User" />)
    ...
    public partial class UserTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Site) , PropertyActiveSite)]
        [TestCaseGeneric(typeof(int) , PropertyActiveSiteId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Group[]) , PropertyActualGroupManagers)]
        [TestCaseGeneric(typeof(string) , PropertyAddressLine1)]
        [TestCaseGeneric(typeof(string) , PropertyAddressLine2)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Group[]) , PropertyAlternateGroupManagers)]
        [TestCaseGeneric(typeof(string) , PropertyAlternatePhoneNumber)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Group) , PropertyApprovalGroup)]
        [TestCaseGeneric(typeof(int) , PropertyApprovalGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Assignment[]) , PropertyAssignments)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Client[]) , PropertyClients)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ExpenseEntry[]) , PropertyExpenseEntries)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ExpenseReport[]) , PropertyExpenseReports)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ExpenseReport[]) , PropertyExpenseReportsCreated)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Group) , PropertyFunctionalGroup)]
        [TestCaseGeneric(typeof(int) , PropertyFunctionalGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Group[]) , PropertyFunctionalGroupManagers)]
        [TestCaseGeneric(typeof(short) , PropertyGender)]
        [TestCaseGeneric(typeof(short) , PropertyHasProjectScheduling)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.HolidaySet) , PropertyHolidaySet)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.BusinessUnit[]) , PropertyManagedBusinessUnits)]
        [TestCaseGeneric(typeof(string) , PropertyMaritalStatus)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Site) , PropertyMasterSite)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.OfflineUserPermissions) , PropertyOfflinePermissions)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.UserPlanningRole[]) , PropertyPlanningRoles)]
        [TestCaseGeneric(typeof(string) , PropertyPostalCode)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Project[]) , PropertyProjectActualManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Project[]) , PropertyProjectAlternateManager)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Project[]) , PropertyProjectManager)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Group) , PropertyResourceGroup)]
        [TestCaseGeneric(typeof(int) , PropertyResourceGroupId)]
        [TestCaseGeneric(typeof(int) , PropertyResourceType)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ResourceTypeHistory[]) , PropertyResourceTypeHistory)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.TagAssociation[]) , PropertyTagAssociation)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Title) , PropertyTitle)]
        [TestCaseGeneric(typeof(int) , PropertyTitleId)]
        [TestCaseGeneric(typeof(int) , PropertyUniqueId)]
        [TestCaseGeneric(typeof(System.Nullable<short>) , PropertyUserAccessStatus)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.UsersBusinessUnits[]) , PropertyUserBusinessUnits)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.UserGroup[]) , PropertyUserGroup)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.UserLeaveTime[]) , PropertyUserLeaveTime)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ResourceType) , PropertyUserResourceType)]
