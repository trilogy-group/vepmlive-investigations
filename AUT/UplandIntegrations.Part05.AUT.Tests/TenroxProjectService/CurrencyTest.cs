...
using Currency = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.Currency" />)
    ...
    public partial class CurrencyTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ChargeEntry[]) , PropertyChargeEntries)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ChargeEntry[]) , PropertyClientChargeEntries)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ChargeEntry[]) , PropertyCostChargeEntries)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.AccountingConnection[]) , PropertyTACCCONSET)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Milestone[]) , PropertyTMILEST)]
        [TestCaseGeneric(typeof(int) , PropertyUniqueId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ChargeEntry[]) , PropertyUserChargeEntries)]
