...
using InvoiceTimEntry = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.InvoiceTimEntry" />)
    ...
    public partial class InvoiceTimEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.InvoiceTimeAdj[]) , PropertyInvoiceTimeAdjs)]
