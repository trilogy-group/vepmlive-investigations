...
using WorkflowState = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.WorkflowState" />)
    ...
    public partial class WorkflowStateTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ProjectWorkflowStateFlag[]) , PropertyProjectWorkflowStateFlag)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.WorkflowTransition[]) , PropertyWorkflowTransition)]
