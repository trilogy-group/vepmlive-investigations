...
using BaseWorkType = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.BaseWorkType" />)
    ...
    public partial class BaseWorkTypeTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.LeaveTimeRuleSetup[]) , PropertyLeaveTime)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.SystemDefault[]) , PropertyTSYSDEFS1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Task[]) , PropertyTask)]
        [TestCaseGeneric(typeof(int) , PropertyUniqueId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.LeaveTimeUserHistory[]) , PropertyUserHistory)]
