...
using ExpenseEntry = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.ExpenseEntry" />)
    ...
    public partial class ExpenseEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ExpenseItem) , PropertyExpenseItem)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ExpenseReport) , PropertyExpenseReport)]
