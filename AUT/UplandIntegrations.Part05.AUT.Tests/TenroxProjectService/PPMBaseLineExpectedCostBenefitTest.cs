...
using PPMBaseLineExpectedCostBenefit = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.PPMBaseLineExpectedCostBenefit" />)
    ...
    public partial class PPMBaseLineExpectedCostBenefitTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.PPMBaseLine) , PropertyBaseLine)]
