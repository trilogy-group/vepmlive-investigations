...
using SystemDefault = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.SystemDefault" />)
    ...
    public partial class SystemDefaultTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ProjectWorkflowMap) , PropertyProjectWorkflow)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.SkillSet) , PropertySkillSet)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Charge) , PropertyTCHARGE)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Charge) , PropertyTCHARGE1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.BaseWorkType) , PropertyTWORKTYPE)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.BaseWorkType) , PropertyTWORKTYPE1)]
