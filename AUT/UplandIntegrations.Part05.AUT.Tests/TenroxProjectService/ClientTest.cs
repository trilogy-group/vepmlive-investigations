...
using Client = UplandIntegrations.TenroxProjectService;

namespace UplandIntegrations.TenroxProjectService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxProjectService.Client" />)
    ...
    public partial class ClientTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.User) , PropertyAccountExecutive)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.ClientInvoiceOption[]) , PropertyClientInvoiceOptions)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxProjectService.Project[]) , PropertyClientProject)]
