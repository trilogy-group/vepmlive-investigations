...
using BusinessUnit = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.BusinessUnit" />)
    ...
    public partial class BusinessUnitTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.User) , PropertyManagedBy)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.UsersBusinessUnits[]) , PropertyUsersBusinessUnits)]
