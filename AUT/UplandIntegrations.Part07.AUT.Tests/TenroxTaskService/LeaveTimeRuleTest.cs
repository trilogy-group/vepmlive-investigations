...
using LeaveTimeRule = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.LeaveTimeRule" />)
    ...
    public partial class LeaveTimeRuleTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.LeaveTimeRuleSetup) , PropertyLeaveTimeRuleSetup)]
