...
using Currency = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.Currency" />)
    ...
    public partial class CurrencyTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ChargeEntry[]) , PropertyChargeEntries)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ChargeEntry[]) , PropertyClientChargeEntries)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ChargeEntry[]) , PropertyCostChargeEntries)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ChargeEntry[]) , PropertyUserChargeEntries)]
