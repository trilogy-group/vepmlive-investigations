...
using PlanningRole = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.PlanningRole" />)
    ...
    public partial class PlanningRoleTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.UserPlanningRole[]) , PropertyMembers)]
        [TestCaseGeneric(typeof(string) , PropertyName)]
        [TestCaseGeneric(typeof(int) , PropertyResourceGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.RoleCalendar[]) , PropertyRoleAvailabilityCalendars)]
