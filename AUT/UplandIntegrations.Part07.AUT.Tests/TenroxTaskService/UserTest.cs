...
using User = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.User" />)
    ...
    public partial class UserTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Site) , PropertyActiveSite)]
        [TestCaseGeneric(typeof(int) , PropertyActiveSiteId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Group[]) , PropertyActualGroupManagers)]
        [TestCaseGeneric(typeof(string) , PropertyAddressLine1)]
        [TestCaseGeneric(typeof(string) , PropertyAddressLine2)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Group[]) , PropertyAlternateGroupManagers)]
        [TestCaseGeneric(typeof(string) , PropertyAlternatePhoneNumber)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Group) , PropertyApprovalGroup)]
        [TestCaseGeneric(typeof(int) , PropertyApprovalGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Assignment[]) , PropertyAssignments)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Client[]) , PropertyClients)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ExpenseReport[]) , PropertyExpenseReports)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ExpenseReport[]) , PropertyExpenseReportsCreated)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Group) , PropertyFunctionalGroup)]
        [TestCaseGeneric(typeof(int) , PropertyFunctionalGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Group[]) , PropertyFunctionalGroupManagers)]
        [TestCaseGeneric(typeof(short) , PropertyGender)]
        [TestCaseGeneric(typeof(short) , PropertyHasProjectScheduling)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.HolidaySet) , PropertyHolidaySet)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.LeaveTimeUserHistory[]) , PropertyLeaveTimeUserHistory)]
        [TestCaseGeneric(typeof(string) , PropertyLoginName)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.BusinessUnit[]) , PropertyManagedBusinessUnits)]
        [TestCaseGeneric(typeof(string) , PropertyMaritalStatus)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Site) , PropertyMasterSite)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.OfflineUserPermissions) , PropertyOfflinePermissions)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.UserPlanningRole[]) , PropertyPlanningRoles)]
        [TestCaseGeneric(typeof(string) , PropertyPostalCode)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Project[]) , PropertyProjectActualManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Project[]) , PropertyProjectAlternateManager)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Project[]) , PropertyProjectManager)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Group) , PropertyResourceGroup)]
        [TestCaseGeneric(typeof(int) , PropertyResourceGroupId)]
        [TestCaseGeneric(typeof(int) , PropertyResourceType)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ResourceTypeHistory[]) , PropertyResourceTypeHistory)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.TagAssociation[]) , PropertyTagAssociation)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.UsersBusinessUnits[]) , PropertyUserBusinessUnits)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.UserGroup[]) , PropertyUserGroup)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.UserLeaveTime[]) , PropertyUserLeaveTime)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ResourceType) , PropertyUserResourceType)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.UserSkill[]) , PropertyUserSkills)]
