...
using WorkflowEntry = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.WorkflowEntry" />)
    ...
    public partial class WorkflowEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.PPMRiskAssociation[]) , PropertyPPMRiskAssociation)]
