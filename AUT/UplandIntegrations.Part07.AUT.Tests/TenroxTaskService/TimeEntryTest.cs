...
using TimeEntry = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.TimeEntry" />)
    ...
    public partial class TimeEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.BusinessUnit) , PropertyBusinessUnit)]
        [TestCaseGeneric(typeof(int) , PropertyBusinessUnitId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ChargeEntry) , PropertyChargeEntry)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Site) , PropertySite)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Phase) , PropertyTPHASE)]
