...
using AccountingConnection = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.AccountingConnection" />)
    ...
    public partial class AccountingConnectionTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Currency) , PropertyTCURRENCY)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Invoice[]) , PropertyTINVOICEs)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.PayableBatch[]) , PropertyTPAYABLEBATCHes)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.PayrollBatch[]) , PropertyTPAYROLLBATCHes)]
