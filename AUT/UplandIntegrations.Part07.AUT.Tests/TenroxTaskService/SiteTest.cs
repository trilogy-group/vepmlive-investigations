...
using Site = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.Site" />)
    ...
    public partial class SiteTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.User[]) , PropertyActiveSiteUsers)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.User[]) , PropertyMasterSiteUsers)]
