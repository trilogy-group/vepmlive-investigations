...
using Client = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.Client" />)
    ...
    public partial class ClientTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.User) , PropertyAccountExecutive)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ClientInvoiceOption[]) , PropertyClientInvoiceOptions)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Project[]) , PropertyClientProject)]
