...
using ProjectWorkflowMap = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.ProjectWorkflowMap" />)
    ...
    public partial class ProjectWorkflowMapTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ProjectWorkflowOption[]) , PropertyProjectWorkflowOption)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.SystemDefault[]) , PropertySystemDefault)]
