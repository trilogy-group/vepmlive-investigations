...
using BaseWorkType = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.BaseWorkType" />)
    ...
    public partial class BaseWorkTypeTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.LeaveTimeRuleSetup[]) , PropertyLeaveTime)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.SystemDefault[]) , PropertyTSYSDEFS1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Task[]) , PropertyTask)]
        [TestCaseGeneric(typeof(int) , PropertyUniqueId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.LeaveTimeUserHistory[]) , PropertyUserHistory)]
