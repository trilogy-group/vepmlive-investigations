...
using WorkflowState = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.WorkflowState" />)
    ...
    public partial class WorkflowStateTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ProjectWorkflowStateFlag[]) , PropertyProjectWorkflowStateFlag)]
