...
using ExpenseEntry = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.ExpenseEntry" />)
    ...
    public partial class ExpenseEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ExpenseItem) , PropertyExpenseItem)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ExpenseReport) , PropertyExpenseReport)]
