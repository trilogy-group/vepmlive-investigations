...
using PortfolioAllocatedBudget = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.PortfolioAllocatedBudget" />)
    ...
    public partial class PortfolioAllocatedBudgetTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.PortfolioBudget) , PropertyPortfolioBudget)]
