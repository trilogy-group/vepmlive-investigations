...
using SystemDefault = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.SystemDefault" />)
    ...
    public partial class SystemDefaultTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ProjectWorkflowMap) , PropertyProjectWorkflow)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.SkillSet) , PropertySkillSet)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.AccountingConnection) , PropertyTACCCONSET)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Charge) , PropertyTCHARGE)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Charge) , PropertyTCHARGE1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.BaseWorkType) , PropertyTWORKTYPE)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.BaseWorkType) , PropertyTWORKTYPE1)]
