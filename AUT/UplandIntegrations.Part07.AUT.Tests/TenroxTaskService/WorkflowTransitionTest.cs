...
using WorkflowTransition = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.WorkflowTransition" />)
    ...
    public partial class WorkflowTransitionTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ProjectWorkflowTransitionFlag[]) , PropertyProjectWorkflowTransitionFlag)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.WorkflowMap) , PropertyWorkflowMap)]
        [TestCaseGeneric(typeof(int) , PropertyWorkflowMapId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.WorkflowState) , PropertyWorkflowState)]
