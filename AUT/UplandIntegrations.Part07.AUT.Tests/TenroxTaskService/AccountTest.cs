...
using Account = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.Account" />)
    ...
    public partial class AccountTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Project[]) , PropertyTPROJECTs)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Project[]) , PropertyTPROJECTs1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Project[]) , PropertyTPROJECTs2)]
