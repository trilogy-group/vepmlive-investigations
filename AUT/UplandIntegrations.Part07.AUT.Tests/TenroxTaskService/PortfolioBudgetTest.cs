...
using PortfolioBudget = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.PortfolioBudget" />)
    ...
    public partial class PortfolioBudgetTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.PortfolioAllocatedBudget[]) , PropertyAllocatedBudgets)]
