...
using Portfolio = UplandIntegrations.TenroxTaskService;

namespace UplandIntegrations.TenroxTaskService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxTaskService.Portfolio" />)
    ...
    public partial class PortfolioTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.PortfolioBudget[]) , PropertyBudgets)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.ProjectWorkflowMap) , PropertyProjectWorkflowMap)]
        [TestCaseGeneric(typeof(int) , PropertyProjectWorkflowMapId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxTaskService.Project[]) , PropertyProjects)]
