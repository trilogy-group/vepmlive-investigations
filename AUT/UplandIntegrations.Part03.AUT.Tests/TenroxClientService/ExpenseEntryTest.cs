...
using ExpenseEntry = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.ExpenseEntry" />)
    ...
    public partial class ExpenseEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ExpenseItem) , PropertyExpenseItem)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ExpenseReport) , PropertyExpenseReport)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Site) , PropertySite)]
