...
using BulkDeleteRequest = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.BulkDeleteRequest" />)
    ...
    public partial class BulkDeleteRequestTest : AbstractBaseSetupV3Test
    {
        ...
        {
            // Arrange
            var p_token = this.CreateType<UplandIntegrations.TenroxClientService.UserToken>();
        ...
        public void AUT_BulkDeleteRequest_Constructors_Overloading_Of_1_Explore_Verify_Test()
        {
            ...
            var methodBulkDeleteRequestPrametersTypes = new Type[] { typeof(UplandIntegrations.TenroxClientService.UserToken), typeof(int[]) };
