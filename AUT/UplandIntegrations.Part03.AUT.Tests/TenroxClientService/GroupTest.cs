...
using Group = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.Group" />)
    ...
    public partial class GroupTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User) , PropertyActualGroupManager)]
        [TestCaseGeneric(typeof(int) , PropertyActualManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User) , PropertyAlternateGroupManager)]
        [TestCaseGeneric(typeof(int) , PropertyAlternateManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User[]) , PropertyApprovedUsers)]
        [TestCaseGeneric(typeof(System.Nullable<int>) , PropertyDefaultTaskId)]
        [TestCaseGeneric(typeof(string) , PropertyDescription)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User) , PropertyFunctionalGroupManager)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User[]) , PropertyFunctionalUsers)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.UserGroup[]) , PropertyResourceGroupUsers)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User[]) , PropertyResourceUsers)]
