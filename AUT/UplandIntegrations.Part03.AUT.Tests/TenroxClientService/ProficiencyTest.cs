...
using Proficiency = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.Proficiency" />)
    ...
    public partial class ProficiencyTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.BookingSkill[]) , PropertyBookingSkills)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ProficiencyDescription[]) , PropertyDescriptions)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.TitleSkill[]) , PropertyTitleSkills)]
