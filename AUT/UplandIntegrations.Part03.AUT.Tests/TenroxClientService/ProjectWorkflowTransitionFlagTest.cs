...
using ProjectWorkflowTransitionFlag = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.ProjectWorkflowTransitionFlag" />)
    ...
    public partial class ProjectWorkflowTransitionFlagTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.WorkflowTransition) , PropertyWorkflowTransition)]
