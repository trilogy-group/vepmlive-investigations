...
using HolidaySet = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.HolidaySet" />)
    ...
    public partial class HolidaySetTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Holiday[]) , PropertyHolidays)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Site[]) , PropertySites)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User[]) , PropertyUsers)]
