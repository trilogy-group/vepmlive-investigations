...
using PPMBaseLine = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.PPMBaseLine" />)
    ...
    public partial class PPMBaseLineTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMBaseLineExpectedCostBenefit[]) , PropertyBaseLineExpectedCostBenefit)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMBaseLineExpectedDuration[]) , PropertyBaseLineExpectedDurations)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMBaseLineTimeHorizon[]) , PropertyBaseLineTimeHorizons)]
