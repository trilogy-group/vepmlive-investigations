...
using Account = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.Account" />)
    ...
    public partial class AccountTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Project[]) , PropertyTPROJECTs)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Project[]) , PropertyTPROJECTs1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Project[]) , PropertyTPROJECTs2)]
