...
using InvoiceTimeAdj = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.InvoiceTimeAdj" />)
    ...
    public partial class InvoiceTimeAdjTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.InvoiceTimEntry) , PropertyInvoiceTimEntry)]
