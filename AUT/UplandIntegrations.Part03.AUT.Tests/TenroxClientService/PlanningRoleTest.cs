...
using PlanningRole = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.PlanningRole" />)
    ...
    public partial class PlanningRoleTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.UserPlanningRole[]) , PropertyMembers)]
        [TestCaseGeneric(typeof(string) , PropertyName)]
        [TestCaseGeneric(typeof(int) , PropertyResourceGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.RoleCalendar[]) , PropertyRoleAvailabilityCalendars)]
