...
using BaseWorkType = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.BaseWorkType" />)
    ...
    public partial class BaseWorkTypeTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.LeaveTimeRuleSetup[]) , PropertyLeaveTime)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.LeaveTimeUserHistory[]) , PropertyUserHistory)]
