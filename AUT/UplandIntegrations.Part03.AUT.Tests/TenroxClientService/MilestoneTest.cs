...
using Milestone = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.Milestone" />)
    ...
    public partial class MilestoneTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Charge) , PropertyCharge)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Currency) , PropertyCurrency)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.MilestoneTask[]) , PropertyMilestoneTask)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Project) , PropertyProject)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ChargeEntry[]) , PropertyTCHARGEENTRies)]
