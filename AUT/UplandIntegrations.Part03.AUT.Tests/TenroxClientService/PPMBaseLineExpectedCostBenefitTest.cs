...
using PPMBaseLineExpectedCostBenefit = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.PPMBaseLineExpectedCostBenefit" />)
    ...
    public partial class PPMBaseLineExpectedCostBenefitTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMBaseLine) , PropertyBaseLine)]
