...
using PortfolioAllocatedBudget = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.PortfolioAllocatedBudget" />)
    ...
    public partial class PortfolioAllocatedBudgetTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PortfolioBudget) , PropertyPortfolioBudget)]
