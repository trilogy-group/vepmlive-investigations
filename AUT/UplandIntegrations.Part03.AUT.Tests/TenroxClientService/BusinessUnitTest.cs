...
using BusinessUnit = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.BusinessUnit" />)
    ...
    public partial class BusinessUnitTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User) , PropertyManagedBy)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.UsersBusinessUnits[]) , PropertyUsersBusinessUnits)]
