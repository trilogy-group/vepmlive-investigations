...
using ProjectWorkflowMap = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.ProjectWorkflowMap" />)
    ...
    public partial class ProjectWorkflowMapTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ProjectWorkflowOption[]) , PropertyProjectWorkflowOption)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.SystemDefault[]) , PropertySystemDefault)]
