...
using DeleteRequest = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.DeleteRequest" />)
    ...
    public partial class DeleteRequestTest : AbstractBaseSetupV3Test
    {
        ...
        public void AUT_DeleteRequest_Constructors_Overloading_Of_1_Explore_Verify_Test()
        {
            ...
            var methodDeleteRequestPrametersTypes = new Type[] { typeof(UplandIntegrations.TenroxClientService.UserToken), typeof(int) };
