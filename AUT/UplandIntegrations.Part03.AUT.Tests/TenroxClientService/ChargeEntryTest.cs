...
using ChargeEntry = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.ChargeEntry" />)
    ...
    public partial class ChargeEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Currency) , PropertyClientCurrency)]
        [TestCaseGeneric(typeof(int) , PropertyClientCurrencyId)]
        [TestCaseGeneric(typeof(decimal) , PropertyCostAmountCostCurrency)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Currency) , PropertyCostCurrency)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.TimeEntry[]) , PropertyTimeEntries)]
        [TestCaseGeneric(typeof(int) , PropertyUniqueId)]
        [TestCaseGeneric(typeof(System.Nullable<System.DateTime>) , PropertyUpdateTimestamp)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Currency) , PropertyUserCurrency)]
