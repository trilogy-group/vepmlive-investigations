...
using PortfolioBudget = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.PortfolioBudget" />)
    ...
    public partial class PortfolioBudgetTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PortfolioAllocatedBudget[]) , PropertyAllocatedBudgets)]
