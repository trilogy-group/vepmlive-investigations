...
using InvoiceTimEntry = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.InvoiceTimEntry" />)
    ...
    public partial class InvoiceTimEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.InvoiceTimeAdj[]) , PropertyInvoiceTimeAdjs)]
