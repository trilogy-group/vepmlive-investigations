...
using BulkDeleteRequest = UplandIntegrations.TenroxIntegrationService;

namespace UplandIntegrations.TenroxIntegrationService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxIntegrationService.BulkDeleteRequest" />)
    ...
    public partial class BulkDeleteRequestTest : AbstractBaseSetupV3Test
    {
        ...
        public void AUT_BulkDeleteRequest_Constructors_Overloading_Of_1_Explore_Verify_Test()
        {
            ...
            var methodBulkDeleteRequestPrametersTypes = new Type[] { typeof(UplandIntegrations.TenroxIntegrationService.UserToken), typeof(int[]) };
