...
using BulkDeleteSerializedResponse = UplandIntegrations.TenroxIntegrationService;

namespace UplandIntegrations.TenroxIntegrationService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxIntegrationService.BulkDeleteSerializedResponse" />)
