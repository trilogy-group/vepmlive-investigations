...
using UplandIntegrations.Tenrox;
using Integrator = UplandIntegrations.Tenrox;

namespace UplandIntegrations.Tenrox
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.Tenrox.Integrator" />)
    ///     and namespace <see cref="UplandIntegrations.Tenrox"/> class using generator(v:0.2.2)'s 
    ...
    public class IntegratorTest : AbstractBaseSetupV3Test
    {
        ...
        private const string MethodGetTenroxService = "GetTenroxService";
        ...
        private const string FieldEXPENSES_URL = "EXPENSES_URL";
        private const string FieldPROJECT_INFO_URL = "PROJECT_INFO_URL";
        private const string FieldTIMESHEET_URL = "TIMESHEET_URL";
        ...
        [TestCase(MethodGetTenroxService, 0)]
        ...
        [Timeout(TestsTimeOut)]
        [Category("AUT Initializer")]
        [TestCase(FieldEXPENSES_URL)]
        [TestCase(FieldPROJECT_INFO_URL)]
        [TestCase(FieldTIMESHEET_URL)]
        ...
        public void AUT_Integrator_GetAuthInfo_Method_Call_Void_With_No_Parameters_Call_Throw_Exception_Thrown_Test()
        {
            ...
            var webProps = this.CreateType<WebProperties>();
            var orgUrl = this.CreateType<string>();
            var orgName = this.CreateType<string>();
            var username = this.CreateType<string>();
            var password = this.CreateType<SecureString>();
            ...
            object[] parametersOfGetAuthInfo = { webProps, orgUrl, orgName, username, password };
            Exception exception = null;
        ...
        #region Method Call : (GetTenroxService) (Return Type : TenroxService) private call definition

        [ExcludeFromCodeCoverage]
        private void AUT_Integrator_GetTenroxService_Method_Call_Internally(Type[] types)
        {
            var methodGetTenroxServicePrametersTypes = types;
            ReflectionAnalyzer.InvokeNonStaticMethodWithDynamicParameters(_integratorInstance, MethodGetTenroxService, Fixture, methodGetTenroxServicePrametersTypes);
        }

        #endregion

        #region Method Call : (GetTenroxService) (Return Type : TenroxService) Results Null (if not primitive type) Test

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetTenroxService_Method_Call_Dynamic_Invoking_Results_Null_If_Not_Primitive_Type_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetTenroxService);
            var methodGetTenroxServicePrametersTypes = new Type[] { typeof(WebProperties) };

            // Act
            var result = ReflectionAnalyzer.InvokeNonStaticMethodWithDynamicParameters(_integratorInstance, MethodGetTenroxService, Fixture, methodGetTenroxServicePrametersTypes);

            // Assert
            result.ShouldBeNull();
            methodGetTenroxServicePrametersTypes.Length.ShouldBe(1);
        }

        #endregion

        #region Method Call : (GetTenroxService) (Return Type : TenroxService) Invoke Should Not Throw

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetTenroxService_Method_Call_Dynamic_Invoking_Should_Not_Throw_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetTenroxService);
            var methodGetTenroxServicePrametersTypes = new Type[] { typeof(WebProperties) };
            ...
            // Act
            Action currentAction = () => ReflectionAnalyzer.InvokeNonStaticMethodWithDynamicParameters(_integratorInstance, MethodGetTenroxService, Fixture, methodGetTenroxServicePrametersTypes);

            // Assert
            Should.NotThrow(currentAction);
            methodGetTenroxServicePrametersTypes.Length.ShouldBe(parametersCount);
        }

        #endregion

        #region Method Call : (GetTenroxService) (Return Type : TenroxService) without parameters value verify result should be null.

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetTenroxService_Method_Call_Dynamic_Invoking_Without_Parameters_Results_Should_Be_Null_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetTenroxService);
            Exception exception;
            var methodInfo = this.GetMethodInfo(MethodGetTenroxService, 0);
        ...
        #region Method Call : (GetTenroxService) (Return Type : TenroxService) Parameters Count verify

        [Test]
        [Timeout(TestsTimeOut)]
        [Category("AUT MethodCallTest")]
        public void AUT_Integrator_GetTenroxService_Method_Call_Parameters_Count_Verification_Test()
        {
            // Arrange
            this.ValidateExecuteCondition(MethodGetTenroxService);
            var methodInfo = this.GetMethodInfo(MethodGetTenroxService, 0);
