...
using TenroxFaultContract = UplandIntegrations.TenroxAuthService;

namespace UplandIntegrations.TenroxAuthService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAuthService.TenroxFaultContract" />)
