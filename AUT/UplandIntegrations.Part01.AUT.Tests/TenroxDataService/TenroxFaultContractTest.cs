...
using TenroxFaultContract = UplandIntegrations.TenroxDataService;

namespace UplandIntegrations.TenroxDataService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxDataService.TenroxFaultContract" />)
    ...
    public partial class TenroxFaultContractTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(string) , PropertyCorrelationId)]
