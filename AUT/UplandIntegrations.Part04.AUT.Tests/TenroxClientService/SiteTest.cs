...
using Site = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.Site" />)
    ...
    public partial class SiteTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User[]) , PropertyActiveSiteUsers)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User[]) , PropertyMasterSiteUsers)]
