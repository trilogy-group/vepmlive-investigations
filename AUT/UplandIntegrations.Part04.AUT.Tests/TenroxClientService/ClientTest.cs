...
using Client = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.Client" />)
    ...
    public partial class ClientTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User) , PropertyAccountExecutive)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ClientInvoiceOption[]) , PropertyClientInvoiceOptions)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Project[]) , PropertyClientProject)]
