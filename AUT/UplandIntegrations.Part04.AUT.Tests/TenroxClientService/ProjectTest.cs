...
using Project = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.Project" />)
    ...
    public partial class ProjectTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User) , PropertyActualManager)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User) , PropertyAlternateManager)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Project[]) , PropertyChildren)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Client) , PropertyClient)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMProjectDependency[]) , PropertyDependentProjects)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.User) , PropertyManager)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMBaseLine[]) , PropertyPPBBaseLines)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMExpectedCostBenefit[]) , PropertyPPMExpectedCostBenefits)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMExpectedDuration[]) , PropertyPPMExpectedDurations)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMGoal[]) , PropertyPPMGoals)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMProjectDependency[]) , PropertyPPMProjectDependencies)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMResourceAllocation[]) , PropertyPPMResourceAllocations)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMSponsor[]) , PropertyPPMSponsors)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PPMTimeHorizon[]) , PropertyPPMTimeHorizons)]
        [TestCaseGeneric(typeof(int) , PropertyPROJECTCONTACTID)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Project) , PropertyParent)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Portfolio) , PropertyPortfolio)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PortfolioAllocatedBudget[]) , PropertyPortfolioAllocatedBudgets)]
        [TestCaseGeneric(typeof(int) , PropertyPortfolioId)]
        [TestCaseGeneric(typeof(string) , PropertyPriority)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ProjectRevenueRecognitionPreference) , PropertyProjectRevenueRecognitionPreference)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ProjectType) , PropertyProjectType)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Account) , PropertyTACCOUNT)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Account) , PropertyTACCOUNT1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Account) , PropertyTACCOUNT2)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Milestone[]) , PropertyTMILEST)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Task[]) , PropertyTask)]
