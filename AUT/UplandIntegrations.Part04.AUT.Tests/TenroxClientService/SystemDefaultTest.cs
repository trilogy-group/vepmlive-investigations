...
using SystemDefault = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.SystemDefault" />)
    ...
    public partial class SystemDefaultTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ProjectWorkflowMap) , PropertyProjectWorkflow)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.SkillSet) , PropertySkillSet)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Charge) , PropertyTCHARGE)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Charge) , PropertyTCHARGE1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.BaseWorkType) , PropertyTWORKTYPE)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.BaseWorkType) , PropertyTWORKTYPE1)]
