...
using TitleSkill = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.TitleSkill" />)
    ...
    public partial class TitleSkillTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Proficiency) , PropertyProficiency)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Skill) , PropertySkill)]
