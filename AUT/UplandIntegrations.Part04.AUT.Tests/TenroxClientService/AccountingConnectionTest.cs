...
using AccountingConnection = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.AccountingConnection" />)
    ...
    public partial class AccountingConnectionTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Currency) , PropertyTCURRENCY)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Invoice[]) , PropertyTINVOICEs)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PayableBatch[]) , PropertyTPAYABLEBATCHes)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.PayrollBatch[]) , PropertyTPAYROLLBATCHes)]
