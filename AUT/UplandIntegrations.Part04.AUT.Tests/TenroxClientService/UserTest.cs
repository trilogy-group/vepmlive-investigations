...
using User = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.User" />)
    ...
    public partial class UserTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Group[]) , PropertyActualGroupManagers)]
        [TestCaseGeneric(typeof(string) , PropertyAddressLine1)]
        [TestCaseGeneric(typeof(string) , PropertyAddressLine2)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Group[]) , PropertyAlternateGroupManagers)]
        [TestCaseGeneric(typeof(string) , PropertyAlternatePhoneNumber)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Group) , PropertyApprovalGroup)]
        [TestCaseGeneric(typeof(int) , PropertyApprovalGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Assignment[]) , PropertyAssignments)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Client[]) , PropertyClients)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ExpenseReport[]) , PropertyExpenseReports)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ExpenseReport[]) , PropertyExpenseReportsCreated)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Group) , PropertyFunctionalGroup)]
        [TestCaseGeneric(typeof(int) , PropertyFunctionalGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Group[]) , PropertyFunctionalGroupManagers)]
        [TestCaseGeneric(typeof(short) , PropertyGender)]
        [TestCaseGeneric(typeof(short) , PropertyHasProjectScheduling)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.HolidaySet) , PropertyHolidaySet)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.LeaveTimeUserHistory[]) , PropertyLeaveTimeUserHistory)]
        [TestCaseGeneric(typeof(string) , PropertyLoginName)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.BusinessUnit[]) , PropertyManagedBusinessUnits)]
        [TestCaseGeneric(typeof(string) , PropertyMaritalStatus)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Site) , PropertyMasterSite)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.OfflineUserPermissions) , PropertyOfflinePermissions)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.UserPlanningRole[]) , PropertyPlanningRoles)]
        [TestCaseGeneric(typeof(string) , PropertyPostalCode)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Project[]) , PropertyProjectActualManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Project[]) , PropertyProjectAlternateManager)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Project[]) , PropertyProjectManager)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Group) , PropertyResourceGroup)]
        [TestCaseGeneric(typeof(int) , PropertyResourceGroupId)]
        [TestCaseGeneric(typeof(int) , PropertyResourceType)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ResourceTypeHistory[]) , PropertyResourceTypeHistory)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.TagAssociation[]) , PropertyTagAssociation)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Title) , PropertyTitle)]
        [TestCaseGeneric(typeof(int) , PropertyTitleId)]
        [TestCaseGeneric(typeof(int) , PropertyUniqueId)]
        [TestCaseGeneric(typeof(System.Nullable<short>) , PropertyUserAccessStatus)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.UsersBusinessUnits[]) , PropertyUserBusinessUnits)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.UserGroup[]) , PropertyUserGroup)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.UserLeaveTime[]) , PropertyUserLeaveTime)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ResourceType) , PropertyUserResourceType)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.UserSkill[]) , PropertyUserSkills)]
