...
using Task = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.Task" />)
    ...
    public partial class TaskTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Assignment[]) , PropertyAssignment)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.BaseWorkType) , PropertyBaseWorkType)]
