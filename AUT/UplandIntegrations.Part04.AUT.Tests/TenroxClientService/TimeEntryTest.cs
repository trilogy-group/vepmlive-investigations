...
using TimeEntry = UplandIntegrations.TenroxClientService;

namespace UplandIntegrations.TenroxClientService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxClientService.TimeEntry" />)
    ...
    public partial class TimeEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.ChargeEntry) , PropertyChargeEntry)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxClientService.Phase) , PropertyTPHASE)]
