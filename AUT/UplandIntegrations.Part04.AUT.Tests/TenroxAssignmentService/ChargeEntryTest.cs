...
using ChargeEntry = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.ChargeEntry" />)
    ...
    public partial class ChargeEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Currency) , PropertyClientCurrency)]
        [TestCaseGeneric(typeof(int) , PropertyClientCurrencyId)]
        [TestCaseGeneric(typeof(decimal) , PropertyCostAmountCostCurrency)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Currency) , PropertyCostCurrency)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Currency) , PropertyUserCurrency)]
