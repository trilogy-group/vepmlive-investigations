...
using WorkflowTransition = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.WorkflowTransition" />)
    ...
    public partial class WorkflowTransitionTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ProjectWorkflowTransitionFlag[]) , PropertyProjectWorkflowTransitionFlag)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.WorkflowMap) , PropertyWorkflowMap)]
