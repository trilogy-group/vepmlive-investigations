...
using Group = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.Group" />)
    ...
    public partial class GroupTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.User) , PropertyActualGroupManager)]
        [TestCaseGeneric(typeof(int) , PropertyActualManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.User) , PropertyAlternateGroupManager)]
        [TestCaseGeneric(typeof(int) , PropertyAlternateManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.User[]) , PropertyApprovedUsers)]
        [TestCaseGeneric(typeof(System.Nullable<int>) , PropertyDefaultTaskId)]
        [TestCaseGeneric(typeof(string) , PropertyDescription)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.User) , PropertyFunctionalGroupManager)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.User[]) , PropertyFunctionalUsers)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.UserGroup[]) , PropertyResourceGroupUsers)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.User[]) , PropertyResourceUsers)]
