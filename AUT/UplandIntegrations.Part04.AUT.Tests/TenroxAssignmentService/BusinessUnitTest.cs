...
using BusinessUnit = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.BusinessUnit" />)
    ...
    public partial class BusinessUnitTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.User) , PropertyManagedBy)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.UsersBusinessUnits[]) , PropertyUsersBusinessUnits)]
