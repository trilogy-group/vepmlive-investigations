...
using Account = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.Account" />)
    ...
    public partial class AccountTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Project[]) , PropertyTPROJECTs)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Project[]) , PropertyTPROJECTs1)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Project[]) , PropertyTPROJECTs2)]
