...
using Currency = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.Currency" />)
    ...
    public partial class CurrencyTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ChargeEntry[]) , PropertyChargeEntries)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ChargeEntry[]) , PropertyClientChargeEntries)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ChargeEntry[]) , PropertyCostChargeEntries)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ChargeEntry[]) , PropertyUserChargeEntries)]
