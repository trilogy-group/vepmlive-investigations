...
using LeaveTimeRule = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.LeaveTimeRule" />)
    ...
    public partial class LeaveTimeRuleTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.LeaveTimeRuleSetup) , PropertyLeaveTimeRuleSetup)]
        [TestCaseGeneric(typeof(short) , PropertyProcessSuspendedUsers)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.RuleExecutionHistory[]) , PropertyRuleExecHistory)]
