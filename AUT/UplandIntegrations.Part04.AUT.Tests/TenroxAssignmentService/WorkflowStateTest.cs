...
using WorkflowState = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.WorkflowState" />)
    ...
    public partial class WorkflowStateTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ProjectWorkflowStateFlag[]) , PropertyProjectWorkflowStateFlag)]
