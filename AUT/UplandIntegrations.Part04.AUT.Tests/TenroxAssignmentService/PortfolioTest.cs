...
using Portfolio = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.Portfolio" />)
    ...
    public partial class PortfolioTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.PortfolioBudget[]) , PropertyBudgets)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ProjectWorkflowMap) , PropertyProjectWorkflowMap)]
        [TestCaseGeneric(typeof(int) , PropertyProjectWorkflowMapId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Project[]) , PropertyProjects)]
