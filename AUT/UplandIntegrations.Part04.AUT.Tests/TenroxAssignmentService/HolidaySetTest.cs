...
using HolidaySet = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.HolidaySet" />)
    ...
    public partial class HolidaySetTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Holiday[]) , PropertyHolidays)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Site[]) , PropertySites)]
