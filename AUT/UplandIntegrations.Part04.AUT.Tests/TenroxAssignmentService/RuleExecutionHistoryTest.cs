...
using RuleExecutionHistory = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.RuleExecutionHistory" />)
    ...
    public partial class RuleExecutionHistoryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.LeaveTimeRule) , PropertyLeaveTimeRule)]
