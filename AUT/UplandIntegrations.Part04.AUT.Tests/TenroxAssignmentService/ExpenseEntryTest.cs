...
using ExpenseEntry = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.ExpenseEntry" />)
    ...
    public partial class ExpenseEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ExpenseItem) , PropertyExpenseItem)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ExpenseReport) , PropertyExpenseReport)]
