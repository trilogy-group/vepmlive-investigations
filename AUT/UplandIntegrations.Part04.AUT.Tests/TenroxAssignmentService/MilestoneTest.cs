...
using Milestone = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.Milestone" />)
    ...
    public partial class MilestoneTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Charge) , PropertyCharge)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Currency) , PropertyCurrency)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.MilestoneTask[]) , PropertyMilestoneTask)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ChargeEntry[]) , PropertyTCHARGEENTRies)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.BaseWorkType) , PropertyWorktype)]
