...
using WorkflowEntry = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.WorkflowEntry" />)
    ...
    public partial class WorkflowEntryTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.PPMRiskAssociation[]) , PropertyPPMRiskAssociation)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.TimeEntry[]) , PropertyTimeEntry)]
