...
using PPMBaseLine = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.PPMBaseLine" />)
    ...
    public partial class PPMBaseLineTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.PPMBaseLineExpectedCostBenefit[]) , PropertyBaseLineExpectedCostBenefit)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.PPMBaseLineExpectedDuration[]) , PropertyBaseLineExpectedDurations)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.PPMBaseLineTimeHorizon[]) , PropertyBaseLineTimeHorizons)]
