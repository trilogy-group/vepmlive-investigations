...
using Proficiency = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.Proficiency" />)
    ...
    public partial class ProficiencyTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.BookingSkill[]) , PropertyBookingSkills)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ProficiencyDescription[]) , PropertyDescriptions)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.TitleSkill[]) , PropertyTitleSkills)]
