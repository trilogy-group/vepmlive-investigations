...
using BulkDeleteRequest = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.BulkDeleteRequest" />)
    ...
    public partial class BulkDeleteRequestTest : AbstractBaseSetupV3Test
    {
        ...
        public void AUT_BulkDeleteRequest_Constructors_Overloading_Of_1_Explore_Verify_Test()
        {
            ...
            var methodBulkDeleteRequestPrametersTypes = new Type[] { typeof(UplandIntegrations.TenroxAssignmentService.UserToken), typeof(int[]) };
