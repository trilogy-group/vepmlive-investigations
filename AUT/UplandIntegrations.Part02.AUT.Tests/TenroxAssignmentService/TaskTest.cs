...
using Task = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.Task" />)
    ...
    public partial class TaskTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Assignment[]) , PropertyAssignment)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.BaseWorkType) , PropertyBaseWorkType)]
