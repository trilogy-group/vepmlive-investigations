...
using AccountingConnection = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.AccountingConnection" />)
    ...
    public partial class AccountingConnectionTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Currency) , PropertyTCURRENCY)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Invoice[]) , PropertyTINVOICEs)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.PayableBatch[]) , PropertyTPAYABLEBATCHes)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.PayrollBatch[]) , PropertyTPAYROLLBATCHes)]
