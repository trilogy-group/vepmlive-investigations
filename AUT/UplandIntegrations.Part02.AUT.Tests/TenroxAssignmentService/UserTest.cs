...
using User = UplandIntegrations.TenroxAssignmentService;

namespace UplandIntegrations.TenroxAssignmentService
{
    /// <summary>
    ///     Automatic Unit Tests or bulk unit tests for (<see cref="UplandIntegrations.TenroxAssignmentService.User" />)
    ...
    public partial class UserTest : AbstractBaseSetupV3Test
    {
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Site) , PropertyActiveSite)]
        [TestCaseGeneric(typeof(int) , PropertyActiveSiteId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Group[]) , PropertyActualGroupManagers)]
        [TestCaseGeneric(typeof(string) , PropertyAddressLine1)]
        [TestCaseGeneric(typeof(string) , PropertyAddressLine2)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Group[]) , PropertyAlternateGroupManagers)]
        [TestCaseGeneric(typeof(string) , PropertyAlternatePhoneNumber)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Group) , PropertyApprovalGroup)]
        [TestCaseGeneric(typeof(int) , PropertyApprovalGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Assignment[]) , PropertyAssignments)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Client[]) , PropertyClients)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ExpenseReport[]) , PropertyExpenseReportsCreated)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Group) , PropertyFunctionalGroup)]
        [TestCaseGeneric(typeof(int) , PropertyFunctionalGroupId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Group[]) , PropertyFunctionalGroupManagers)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.LeaveTimeUserHistory[]) , PropertyLeaveTimeUserHistory)]
        [TestCaseGeneric(typeof(string) , PropertyLoginName)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.BusinessUnit[]) , PropertyManagedBusinessUnits)]
        [TestCaseGeneric(typeof(string) , PropertyMaritalStatus)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Site) , PropertyMasterSite)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.OfflineUserPermissions) , PropertyOfflinePermissions)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.UserPlanningRole[]) , PropertyPlanningRoles)]
        [TestCaseGeneric(typeof(string) , PropertyPostalCode)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Project[]) , PropertyProjectActualManagerId)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Project[]) , PropertyProjectAlternateManager)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Project[]) , PropertyProjectManager)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Group) , PropertyResourceGroup)]
        [TestCaseGeneric(typeof(int) , PropertyResourceGroupId)]
        [TestCaseGeneric(typeof(int) , PropertyResourceType)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ResourceTypeHistory[]) , PropertyResourceTypeHistory)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.TagAssociation[]) , PropertyTagAssociation)]
        ...
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.Title) , PropertyTitle)]
        [TestCaseGeneric(typeof(int) , PropertyTitleId)]
        [TestCaseGeneric(typeof(int) , PropertyUniqueId)]
        [TestCaseGeneric(typeof(System.Nullable<short>) , PropertyUserAccessStatus)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.UsersBusinessUnits[]) , PropertyUserBusinessUnits)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.UserGroup[]) , PropertyUserGroup)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.UserLeaveTime[]) , PropertyUserLeaveTime)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.ResourceType) , PropertyUserResourceType)]
        [TestCaseGeneric(typeof(UplandIntegrations.TenroxAssignmentService.UserSkill[]) , PropertyUserSkills)]
