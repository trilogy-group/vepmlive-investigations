    ...
    Optimizer.prototype.PopulateUI = function () {
        ...
        try {
            ...
            if (this.Views.length == 0) {
                selectviews.options[0] = new Option("-- No View --", -1, true, true);
            }
            else {
            ...
            switch (event) {
                ...
                case "AnalyzerTab_RenameView":
                    ...
                    if (this.AnalyzerViewDlg == null) {
                        ...
                        this.AnalyzerViewDlg.window("winOptimizerViewDlg").button("minmax1").hide();
                ...
                case "AnalyzerTab_DeleteView":
                    ...
                    if (selectView.value == '-1') {
                        ...
                        select.options[0] = new Option("-- No View --", -1, true, true);
                        this.viewTab.refreshSelect("idAnalyzerTab_SelView");
                        alert("There is no view to delete");
                        break;
                    }
                    ...
                    if (this.AnalyzerDeleteViewDlg == null) {
                        ...
                        this.AnalyzerDeleteViewDlg.window("winOptimizerDeleteViewDlg").button("minmax1").hide();
