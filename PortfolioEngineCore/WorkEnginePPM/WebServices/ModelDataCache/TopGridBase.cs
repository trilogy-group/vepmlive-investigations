...
namespace ModelDataCache
{
    ...
    {
        // (CC-76582, 2018-07-12) Not obvious whether these attributes enable or disable sorting/filtering, therefore adding a generic name. 
        // Contributors that know the project behavior may feel free to change the names.
        protected virtual bool RenderGridLayoutSortingAttribute => false;
        protected virtual bool RenderGridLayoutFilteringAttribute => false;
        ...
        public override bool InitializeGridLayout()
        {
            ...
            if (RenderGridLayoutSortingAttribute)
            {
                xCfg.CreateIntAttr("Sorting", 0);
            }

            if (RenderGridLayoutFilteringAttribute)
            {
        ...
        public void AddPeriodColumns(IEnumerable<PeriodData> periods)
        {
            AddPeriodColumns(periods, (periodData, index) => index.ToString());
        }
