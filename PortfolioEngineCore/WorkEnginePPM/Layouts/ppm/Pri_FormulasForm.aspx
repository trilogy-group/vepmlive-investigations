...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pri_FormulasForm.aspx.cs" Inherits="WorkEnginePPM.Pri_FormulasForm" DynamicMasterPageFile="~masterurl/default.master" %>
                ...
                <table width="100%" cellspacing="0">
                    ...
                    <tr>
                        <td width="250" class="descriptioncell" colspan = "2">
                            Select the Prioritization Scenario(s) from the available Custom Fields
                        </td>
                    </tr>
                    <tr>
                        <td class="controlcell">
                            <table cellspacing="0" cellpadding="5">
                                <tr>
                                    ...
                                    <td><asp:ListBox ID="lstFormulas" runat="server" Height="150" Width="160" 
                                            SelectionMode="Multiple"></asp:ListBox> </td>
                                </tr>
                            </table>
                        </td>
