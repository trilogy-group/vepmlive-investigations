...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomFieldForm.aspx.cs" Inherits="WorkEnginePPM.Layouts.ppm.CustomFieldForm" DynamicMasterPageFile="~masterurl/default.master" %>
    ...
    <table width="100%" cellspacing="0">
        ...
        <tr>
            <td width="250" class="descriptioncell">
                Entity</td>
            <td class="controlcell">
                <asp:DropDownList id="ddlEntity" runat="server" Width="200px" OnChange="ddlEntity_OnChange()">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="250" class="descriptioncell">
                Field Type</td>
            <td class="controlcell">
                <asp:DropDownList id="ddlFieldType" runat="server" Width="200px">
                </asp:DropDownList>
            </td>
        </tr>
...
<script type="text/javascript">
    ...
    function ddlEntity_OnChange() {
        alert("EntityChange");
        //alert(document.getElementById("ddlEntity").value);
        var entity = document.getElementById("<%= ddlEntity.ClientID %>").value;
        if (entity == 1) {
            alert("Resource");
        } else if (entity == 2) {
            alert("Portfolio");
