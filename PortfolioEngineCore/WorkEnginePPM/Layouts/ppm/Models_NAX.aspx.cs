...
{
    public partial class Models_NAX : LayoutsPageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    dg.AddColumn(title: "Name", width: 250, name: "MODEL_NAME");
                    dg.AddColumn(title: "Description", width: 600, name: "MODEL_DESC");
                    dg.AddColumn(title: "ID", width: 50, name: "MODEL_UID", isId: true);

                    DataTable dt;
                    dbaModels.SelectModels(dba, out dt);
                    dba.Close();
