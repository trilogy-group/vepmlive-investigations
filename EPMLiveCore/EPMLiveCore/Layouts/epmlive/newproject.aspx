...
<%@ Page Language="C#" Inherits="EPMLiveCore.newproject" MasterPageFile="~/_layouts/application.master"%> 
...
<asp:Content ID="Content4" ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
	<SharePoint:EncodedLiteral ID="EncodedLiteral1" runat="server" text="Create Project" EncodeMethod='HtmlEncode'/>
</asp:Content>

<asp:content ID="Content1" contentplaceholderid="PlaceHolderPageTitleInTitleArea" runat="server">
	<asp:Label ID="lblTitle" runat="server" Text="Create Project"></asp:Label>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderId="PlaceHolderPageDescription" runat="server">
<asp:Panel ID="Panel4" runat="server" Visible="true">
    Use this page to create a new project. Select an option below to continue.
</asp:Panel>
</asp:Content>
...
<input type="hidden" name="hdnSelectedWorkspace" />
<input type="hidden" name="hdnWorkspaceType" id="hdnWorkspaceType"/>
<input type="hidden" name="baseurl" value="<%=this.URL%>"/>

<TABLE border="0" cellspacing="0" cellpadding="0" class="ms-propertysheet">

<wssuc:InputFormSection Title="Project Name"
    ...
    <wssuc:InputFormSection Title="Workspace Type"
		...
		<Template_InputFormControls>
		    <wssuc:InputFormControl LabelText="" runat="server">
                ...
                <input type="radio" name="rdoWorkspace" value="Existing" onclick="javascript:existingWorkspace();" <%=wsTypeExisting %>/> Existing Workspace<br />
