...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uninstallcheck.aspx.cs" Inherits="EPMLiveCore.uninstallcheck" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderId="PlaceHolderMain" runat="server">
    ...
    <script language="javascript">
        ...
        dhtmlxAjax.post("proxy.aspx", "Action=StartUninstallCheck&AppID=<%=Request["AppId"]%>", StartUninstallCheckClose);
        ...
        function CheckStatusClose(loader) 
        {
            ...
            switch(oResponse.Status)
            {
                case "2":
                    ...
                    location.href = "UninstallCheckDone.aspx?AppId=<%=Request["AppId"]%>&isdlg=1";
                    break;
                default:
    ...
    <div style="width:100%; text-align:center; height:100%">
        ...
        Uninstall Check Running (<span id="spnPercent">0</span>%)<br /><br />
        ...
        <div id="divDone" class="alert alert-info" style="width: 400px; display:none; margin-left: auto; margin-right: auto;">
            <strong>Success: </strong>The Uninstall Check is complete, processing results.
        </div>
    </div>
</asp:Content>
