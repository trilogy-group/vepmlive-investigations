...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <script language="javascript">
        ...
        function loadGrids()
        {
            ...
            TreeGrid(   { 
                Layout:{ Url:"../../_vti_bin/WorkEngine.asmx",Repeat: 3,Timeout:0, Method:"Soap",Function:"Execute",Namespace:"workengine.com",Param:{Function:"GetTeamGridLayout",Dataxml:"<%=sLayoutParam %>" } } ,
                Data:{ Url:"../../_vti_bin/WorkEngine.asmx",Repeat: 3,Timeout:0, Method:"Soap",Function:"Execute",Namespace:"workengine.com",Param:{Function:"GetTeamGridData",Dataxml:"<%=sLayoutParam %>" } }, 
