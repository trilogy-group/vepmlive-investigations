...
function newWorkspace()
{
    ...
    document.getElementById("ctl00_PlaceHolderMain_ctl06").style.display ="none";
    document.getElementById("ctl00_PlaceHolderMain_ctl06_tablerow1").style.display ="none";
...
function existingWorkspace()
{
    ...
    document.getElementById("ctl00_PlaceHolderMain_ctl06").style.display ="";
    document.getElementById("ctl00_PlaceHolderMain_ctl06_tablerow1").style.display ="";
    ...
    mygrid.loadXML("getworkspacexml.aspx?List=Project%20Center");
    
}

function existingWorkspaceApp(listname)
{
    document.getElementById("ctl00_PlaceHolderMain_ctl02").style.display ="none";
    document.getElementById("ctl00_PlaceHolderMain_ctl02_tablerow1").style.display ="none";
...
function checkUrl()
{
    ...
    if(document.getElementById("ctl00_PlaceHolderMain_ctl00_ctl00_txtTitle").value == "")
    {
    ...
    {
        if(document.getElementById("ctl00_PlaceHolderMain_ctl03_ctl00_txtURL").value == "")
        {
            alert('You must enter a url');
            return false;
        }
        var url = document.getElementById("ctl00_PlaceHolderMain_ctl03_ctl00_txtURL").value;
        document.getElementById("ctl00_PlaceHolderMain_ctl07_RptControls_btnOK").disabled = true;
        var bUrl = checkURLInUse(url);
        document.getElementById("ctl00_PlaceHolderMain_ctl07_RptControls_btnOK").disabled = false;
