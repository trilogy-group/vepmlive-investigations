...
<%@ Page Language="C#" Inherits="EPMLiveCore.synchperiods"%>

<html>
<head runat="server">
    <title>Synchronize Periods</title>
        ...
        <table border="0" cellpadding="10" cellspacing="0" width="100%" height="100%">
            <tr>
                <td class="ms-linksectionheader" valign="middle" align="center" >
                    <h3 class="ms-standardheader">Periods have been synchronized to all sub-sites.</h3>
                </td>
            </tr>
        </table>
