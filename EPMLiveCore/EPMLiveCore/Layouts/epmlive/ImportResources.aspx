...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <asp:Panel runat="server" ID="WarningPanel" Visible="false">
        <div class="container">
            <div class="form-import">
                <h5 class="form-import-heading" style="font-style:normal; color:red;"><%= msg %></h5>                
                <div class="form-actions">
                    <asp:Button ID="BtnOk" runat="server" Text="OK" OnClick="BtnOk_Click" />
                    <input type="button" id="BtnCancel" value="Cancel" style="margin-left: 5px;" onclick="parent.SP.UI.ModalDialog.commonModalDialogClose(parent.SP.UI.DialogResult.cancel); return false;"/>
                </div>
            </div>
        </div>
    </asp:Panel>
