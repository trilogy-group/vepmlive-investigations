...
(function (epmLiveNotifications, $$, $, k, undefined) {
    ...
    function hideNotifications(counter, screen) {
        if (notificationsAreVisible()) {
            ...
            notificationCounter.css("background", "#547194");
    ...
    function initializeNotifications() {
        ...
        if (notifications) {
            ...
            notifications.css("top", $("#EPMLiveNotificationCounterScreen").height() - 1);
    ...
    function renderNotificationCounter() {
        ...
        notificationCounterScreen.css("top", -(notificationCounter.offset().top * 2) + 5);
        notificationCounterScreen.css("left", -(((topBarHeight - notificationCounter.width()) * 2) + 2));
...
} (window.epmLiveNotifications = window.epmLiveNotifications || {}, epmLive, jQuery, ko));