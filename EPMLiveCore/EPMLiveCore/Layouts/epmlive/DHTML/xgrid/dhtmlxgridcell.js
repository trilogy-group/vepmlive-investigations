...
function dhtmlXGridCellObject(obj){this.destructor=function(){this.cell.obj=null;this.cell=null;this.grid=null;this.base=null;return null};this.cell=obj;this.getValue=function(){if ((this.cell.firstChild)&&(this.cell.firstChild.tagName == "TEXTAREA"))
 ...
 }; this.getPosition = function (oNode) { var oCurrentNode = oNode; var iLeft = 0; var iTop = 0; while (oCurrentNode.tagName != "BODY") { iLeft += oCurrentNode.offsetLeft; iTop += oCurrentNode.offsetTop; oCurrentNode = oCurrentNode.offsetParent }; return new Array(iLeft, iTop) } 
...
function eXcell_ed(cell) {
    ...
    this.edit = function () {
        ...
        this.obj.onselectstart = function (e) {
            if (!e) e = event; e.cancelBubble = true; return true
        };
...
eXcell_edn.prototype.setValue = function (val) {
 ...
 function eXcell_ch(cell){if (cell){this.cell=cell;this.grid=this.cell.parentNode.grid};this.disabledF=function(fl){if ((fl == true)||(fl == 1))
