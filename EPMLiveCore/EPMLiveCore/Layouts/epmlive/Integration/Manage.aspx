...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <SharePoint:SPGridView runat="server"
        ...
        <Columns>
	        <SharePoint:SPMenuField HeaderText="Integration Name" TextFields="Title" MenuFormat="ArrowAlwaysVisible" MenuTemplateId="IntegrationMenu" TokenNameAndValueFields="INTLISTID=INT_LIST_ID,LISTID=LIST_ID" ></SharePoint:SPMenuField>
