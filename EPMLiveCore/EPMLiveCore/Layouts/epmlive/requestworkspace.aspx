...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="requestworkspace.aspx.cs" Inherits="EPMLiveCore.requestworkspace" DynamicMasterPageFile="~masterurl/default.master" %>

<asp:Content ID="Content4" ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
	Create Workspace
</asp:Content>
<asp:Content ID="Content1" contentplaceholderid="PlaceHolderPageTitleInTitleArea" runat="server">
	Create Workspace For: <%=strName %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderId="PlaceHolderPageDescription" runat="server">
<asp:Panel ID="Panel4" runat="server" Visible="true">
    Use this page to create a new workspace for <%=strName %>. Select an option below to continue.
</asp:Panel>
</asp:Content>
