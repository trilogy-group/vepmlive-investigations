...
<%@ Page Language="C#" Inherits="EPMLiveCore.addcode"%>
...
<body>
    ...
    <br />
        <table>
            ...
            <tr>
                <td></td>
                <td style="width: 223px"><asp:Button ID="btnSubmit" runat="server" Text="Add Outline Code" OnClick="btnSubmit_Click" /></td>
            </tr>
        </table> 
    </div>
    </form>
