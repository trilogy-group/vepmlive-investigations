...
{
    internal class ApplicationUninstaller : ApplicationBase
    {
        ...
        public ApplicationUninstaller(string id, SqlConnection cn, EPMLiveCore.Jobs.Applications.Uninstall configJob): base (id, cn)
        {
