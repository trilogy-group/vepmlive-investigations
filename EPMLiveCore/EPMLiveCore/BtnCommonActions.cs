    ...
    public class BtnCommonActions : WebControl, INamingContainer
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (commonActionsList != null && commonActionsList.Items.Count > 0)
            {
                ...
                writer.Write("<A id=lnkCommonActions class=ms-socialNotif onclick=\"ToggleCommonActionsMenu();return false;\" href=\"javascript:;\"  style=\"width:55px\"><SPAN onlick=\"document.getElementById('lnkCommonActions').click()\"><SPAN onlick=\"document.getElementById('lnkCommonActions').click()\" style=\"POSITION: relative; WIDTH: 32px; DISPLAY: inline-block; HEIGHT: 32px; OVERFLOW: hidden\" ><IMG style=\"BORDER-BOTTOM: 0px; POSITION: absolute; BORDER-LEFT: 0px; BORDER-TOP: 0px; BORDER-RIGHT: 0px; LEFT: 0px !important\" src=\"/_layouts/epmlive/images/commonactions.gif\"></SPAN><SPAN class=ms-socialNotif-text>Common Actions</SPAN></SPAN></A>");
