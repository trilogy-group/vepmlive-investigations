...
{
    [UpgradeStep(Version = EPMLiveVersion.V631, Order = 3.0, Description = "VwMetaUpdate Update.")]
    internal class VwMetaUpdate : UpgradeStep
    {
        public VwMetaUpdate(SPWeb spWeb, bool isPfeSite) : base(spWeb, isPfeSite)
        {
        }
...
SELECT        TSTIMESHEET_1.USERNAME, TSTIMESHEET_1.RESOURCENAME AS [Resource Name], TSUSER_1.USER_ID AS SharePointAccountID, TSITEM_1.LIST_UID, TSITEM_1.ITEM_ID, TSITEM_1.TS_ITEM_UID, TSITEM_1.TITLE, TSITEM_1.PROJECT, 
                         TSITEM_1.PROJECT_ID, 'Resource_' + dbo.TSRESMETA.ColumnName AS listcolumnname, dbo.TSRESMETA.DisplayName, dbo.TSRESMETA.ColumnValue, TSITEM_1.ITEM_TYPE, TSITEM_1.TS_UID, 
                         TSTIMESHEET_1.PERIOD_ID, TSTIMESHEET_1.SITE_UID, TSITEM_1.LIST, TSITEMHOURS_1.TS_ITEM_DATE, TSITEMHOURS_1.TS_ITEM_HOURS, TSITEMHOURS_1.TS_ITEM_TYPE_ID, 
...
FROM            dbo.TSTIMESHEET AS TSTIMESHEET_1 INNER JOIN
						...
						dbo.TSUSER AS TSUSER_1 ON TSTIMESHEET_1.TSUSER_UID = TSUSER_1.TSUSERUID");
                            ...
                            LogMessage("VwMeta view updated.", MessageKind.SUCCESS, 4);
                        }
                        else
                        {
                            LogMessage("VwMeta views already updated.", MessageKind.SKIPPED, 4);
                        }
