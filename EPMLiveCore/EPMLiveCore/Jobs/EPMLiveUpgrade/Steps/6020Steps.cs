...
{
    [UpgradeStep(Version = EPMLiveVersion.V601, Order = 3.0, Description = "New email templates to accomplish a new feature: the non-team member time allocation notification.")]
