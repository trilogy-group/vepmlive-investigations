...
begin
    INSERT INTO INT_MODULES (MODULE_ID,NetAssembly,NetClass,[Title],Description,Icon,CustomProps,AvailableOnline,INT_CAT_ID) VALUES ('a0950b9b-3525-40b8-a456-7403156dc492','UplandIntegrations, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5','UplandIntegrations.Tenrox.Integrator','Tenrox','','tenrox.png','<Properties><Connection><Input Type="Text" Property="OrgUrl" Title="Organization URL" /><Input Type="Text" Property="OrgName" Title="Organization Name" /><Input Type="Text" Property="Username" Title="Username" /><Input Type="Password" Property="Password" Title="Password" /></Connection><General><Input Type="Select" Property="Object" Title="Select an object to map" /><Input Type="Text" Property="Fields" Title="Comma separated list of object fields to map" /><Input Type="Select" Property="UserMapType" Title="Select the user mapping field" /></General></Properties>','True','599c89b2-6330-4e54-aea5-00185f20cce0')
end
else
begin
    UPDATE INT_MODULES SET NetAssembly='UplandIntegrations, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5', NetClass='UplandIntegrations.Tenrox.Integrator', [Title]='Tenrox', Description='', Icon='tenrox.png', CustomProps='<Properties><Connection><Input Type="Text" Property="OrgUrl" Title="Organization URL" /><Input Type="Text" Property="OrgName" Title="Organization Name" /><Input Type="Text" Property="Username" Title="Username" /><Input Type="Password" Property="Password" Title="Password" /></Connection><General><Input Type="Select" Property="Object" Title="Select an object to map" /><Input Type="Text" Property="Fields" Title="Comma separated list of object fields to map" /><Input Type="Select" Property="UserMapType" Title="Select the user mapping field" /></General></Properties>', AvailableOnline='True',INT_CAT_ID='599c89b2-6330-4e54-aea5-00185f20cce0' where MODULE_ID='a0950b9b-3525-40b8-a456-7403156dc492'
end
