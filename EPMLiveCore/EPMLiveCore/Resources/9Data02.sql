...
begin
    INSERT INTO INT_MODULES (MODULE_ID,NetAssembly,NetClass,[Title],Description,Icon,CustomProps,AvailableOnline,INT_CAT_ID) VALUES ('b0950b9b-3525-40b8-a456-6403156dc000','EPM Live Core, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5','EPMLiveCore.Integrations.Jira','Jira','','jira.png','<Properties><Connection><Input Type="Text" Property="ServerUrl" Title="Jira Server Url" /><Input Type="Text" Property="Username" Title="Username" /><Input Type="Text" Property="Password" Title="Password" /></Connection><General><Input Type="Text" Property="Object" Title="Object" /></General></Properties>','','7b2ee2fd-9a59-4cca-b3ad-1e8a3017dc60')
end
else
begin
    UPDATE INT_MODULES SET NetAssembly='EPM Live Core, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5', NetClass='EPMLiveCore.Integrations.Jira', [Title]='Jira', Description='', Icon='jira.png', CustomProps='<Properties><Connection><Input Type="Text" Property="ServerUrl" Title="Jira Server Url" /><Input Type="Text" Property="Username" Title="Username" /><Input Type="Text" Property="Password" Title="Password" /></Connection><General><Input Type="Text" Property="Object" Title="Object" /></General></Properties>', AvailableOnline='',INT_CAT_ID='7b2ee2fd-9a59-4cca-b3ad-1e8a3017dc60' where MODULE_ID='b0950b9b-3525-40b8-a456-6403156dc000'
end
if not exists (select MODULE_ID from INT_MODULES where MODULE_ID = 'a0950b9b-3525-40b8-a456-7403156dc491')
begin
    INSERT INTO INT_MODULES (MODULE_ID,NetAssembly,NetClass,[Title],Description,Icon,CustomProps,AvailableOnline,INT_CAT_ID) VALUES ('a0950b9b-3525-40b8-a456-7403156dc491','UplandIntegrations, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5','UplandIntegrations.PS.Integrator','PowerSteering','','ps.png','','True','599c89b2-6330-4e54-aea5-00185f20cce0')
end
else
begin
    UPDATE INT_MODULES SET NetAssembly='UplandIntegrations, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5', NetClass='UplandIntegrations.PS.Integrator', [Title]='PowerSteering', Description='', Icon='ps.png', CustomProps='', AvailableOnline='True',INT_CAT_ID='599c89b2-6330-4e54-aea5-00185f20cce0' where MODULE_ID='a0950b9b-3525-40b8-a456-7403156dc491'
end
if not exists (select MODULE_ID from INT_MODULES where MODULE_ID = 'a0950b9b-3525-40b8-a456-7403156dc492')
begin
    INSERT INTO INT_MODULES (MODULE_ID,NetAssembly,NetClass,[Title],Description,Icon,CustomProps,AvailableOnline,INT_CAT_ID) VALUES ('a0950b9b-3525-40b8-a456-7403156dc492','UplandIntegrations, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5','UplandIntegrations.Tenrox.Integrator','Tenrox','','tenrox.png','<Properties><Connection><Input Type="Text" Property="OrgUrl" Title="Organization URL" /><Input Type="Text" Property="OrgName" Title="Organization Name" /><Input Type="Text" Property="Username" Title="Username" /><Input Type="Password" Property="Password" Title="Password" /></Connection><General><Input Type="Select" Property="Object" Title="Select an object to map" /><Input Type="Select" Property="UserMapType" Title="Select the user mapping field" /></General></Properties>','True','599c89b2-6330-4e54-aea5-00185f20cce0')
end
else
begin
    UPDATE INT_MODULES SET NetAssembly='UplandIntegrations, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9f4da00116c38ec5', NetClass='UplandIntegrations.Tenrox.Integrator', [Title]='Tenrox', Description='', Icon='tenrox.png', CustomProps='<Properties><Connection><Input Type="Text" Property="OrgUrl" Title="Organization URL" /><Input Type="Text" Property="OrgName" Title="Organization Name" /><Input Type="Text" Property="Username" Title="Username" /><Input Type="Password" Property="Password" Title="Password" /></Connection><General><Input Type="Select" Property="Object" Title="Select an object to map" /><Input Type="Select" Property="UserMapType" Title="Select the user mapping field" /></General></Properties>', AvailableOnline='True',INT_CAT_ID='599c89b2-6330-4e54-aea5-00185f20cce0' where MODULE_ID='a0950b9b-3525-40b8-a456-7403156dc492'
end
