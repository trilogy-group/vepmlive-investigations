...
namespace EPMLiveIntegration
{
    public interface IIntegrator
    {
        ...
        DataTable PullData(WebProperties WebProps, IntegrationLog log, string Query, DataTable Items);
        ...
        bool RemoveIntegration(WebProperties WebProps, IntegrationLog Log, out string Message);
    }
