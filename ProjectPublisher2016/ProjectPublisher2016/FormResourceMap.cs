...
namespace ProjectPublisher2016
{
	...
	/// </summary>
	public class FormResourceMap : System.Windows.Forms.Form
    {
		...
		public FormResourceMap(Project project)
		{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormResourceMap));
            ...
            this.label1.Text = "SharePoint Members";
            // 
            // listView1
            // 
            ...
            this.listView2.Location = new System.Drawing.Point(405, 67);
            ...
            this.button3.Location = new System.Drawing.Point(629, 299);
            ...
            this.button4.Location = new System.Drawing.Point(309, 147);
            ...
            this.button5.Location = new System.Drawing.Point(309, 267);
            ...
            // linkLabel1
            // 
            this.linkLabel1.Location = new System.Drawing.Point(5, 299);
            this.linkLabel1.Name = "linkLabel1";
            this.linkLabel1.Size = new System.Drawing.Size(224, 16);
            this.linkLabel1.TabIndex = 18;
            this.linkLabel1.TabStop = true;
            this.linkLabel1.Text = "Add SharePoint Members";
            ...
            // linkLabel2
            // 
            this.linkLabel2.Location = new System.Drawing.Point(69, 27);
            ...
            this.chkHideResMap.Location = new System.Drawing.Point(341, 299);
            ...
            this.Name = "FormResourceMap";
            this.ShowInTaskbar = false;
            this.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Hide;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Resource Map";
            this.TopMost = true;
		...
		private void loadIt()
		{
			...
			for(int i = 0;i<CheckResources.resCount;i++)
			{
				...
				listView1.Items.Insert(getIndex(listView1,CheckResources.resList[i].name),li);
						...
						for(int i = 0;i<CheckResources.resCount;i++)
						{
							if(CheckResources.resList[i].matchedResID == res.UniqueID)
							{
								if(CheckResources.resList[i].changed)
								{
									...
									li.SubItems[1].Text = CheckResources.resList[i].email;
									li.ImageIndex = 0;
								}
								else
									li.ImageIndex = 0;
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			if(email != "")
			{
				listView1.SelectedItems[0].SubItems[1].Text = email;
				listView1.SelectedItems[0].ImageIndex = 0;
				listView2.SelectedItems[0].ImageIndex = 0;
				listView2.SelectedItems[0].SubItems[0] = listView1.SelectedItems[0].SubItems[0];
		...
		private void button4_Click(object sender, System.EventArgs e)
		{
			if(listView1.SelectedItems.Count > 0)
			{
				...
				{
					FormEmail frmEmail = new FormEmail();
					frmEmail.label1.Text = "An E-mail address must be specified to add a resources. Please enter an E-mail address for " + listView1.SelectedItems[0].SubItems[0].Text;
					frmEmail.ShowDialog();
					if(frmEmail.DialogResult == DialogResult.OK)
					{
						for(int i =0;i<CheckResources.resCount;i++)
				...
				if(email != "")
				{
					foreach(ListViewItem liTemp in listView2.Items)
					{
						if(liTemp.SubItems[1].Text == email)
						{
							MessageBox.Show("That resource already exists in Microsoft Project");
							return;
						}
					}
					listView1.SelectedItems[0].SubItems[1].Text = email;
					for(int i =0;i<CheckResources.resCount;i++)
					{
						if(CheckResources.resList[i].resId == int.Parse(listView1.SelectedItems[0].Tag.ToString()))
						{
							ListViewItem li = new ListViewItem(new string[]{listView1.SelectedItems[0].SubItems[0].Text,listView1.SelectedItems[0].SubItems[1].Text});
							li.ImageIndex = 0;
		...
		private void button5_Click_1(object sender, System.EventArgs e)
		{
			...
			frmStatus.Show();
			frmStatus.Refresh();
			//BuildTeam.build(CheckResources.app.ActiveProject, Connection.url);
		...
		{
			System.Diagnostics.Process.Start("IExplore"," " + Connect.getProperty("EPMLiveURL",pj) + "/_layouts/aclinv.aspx");
		}
		...
		private void button6_Click(object sender, System.EventArgs e)
		{
			if(listView2.SelectedItems.Count > 0)
			{
				...
				else
				{
					for(int i =0;i<CheckResources.resCount;i++)
					{
						//MessageBox.Show(listView2.SelectedItems[0].Tag.ToString());
