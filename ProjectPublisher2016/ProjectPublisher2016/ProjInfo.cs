...
namespace ProjectPublisher2016
{
    ...
    public class ProjInfo
    {
            ...
            foreach (XmlNode nd in node["Fields"].ChildNodes)
            {
                ...
                if (hidden != "TRUE" && ro != "TRUE" && validField(name) && validType(type) && !Connect.validWssField(type, name, out iTemp, out bTemp, true) && (editable == "true" || editable == ""))
                {
                    ...
                    switch (type.ToUpper())
                    {
                        ...
                        case "TEXT":
                        case "NOTE":
                            addTextField(nd, li, name, type.ToUpper(), disabled);
                            break;
                        case "CHOICE":
                            addChoiceField(nd, li, name, disabled);
                            break;
                        case "MULTICHOICE":
                            addMultiSelectField(nd, li, name, disabled);
                            break;
                        case "BOOLEAN":
                            addCheckField(li, name, disabled);
                            break;
                        case "DATETIME":
                            addDateField(li, name, disabled);
                            break;
                        case "USER":
                            addUserField(nd, li, name, resList, disabled);
                            break;
                        case "LOOKUP":
                            addLookupField(nd, li, name, disabled);
                            break;
                    };
        ...
        private static void addCheckField(ListViewItem li, string name, string disabled)
        {
        ...
        private static void addMultiSelectField(XmlNode nd, ListViewItem li, string name, string disabled)
        {
            Font f = new Font("Arial", 10, GraphicsUnit.Pixel);
        ...
        private static void addTextField(XmlNode nd, ListViewItem li, string name, string type, string disabled)
        {
        ...
        private static void addDateField(ListViewItem li, string name, string disabled)
        {
            Font f = new Font("Arial", 10, GraphicsUnit.Pixel);
        ...
        private static void addLookupField(XmlNode nd, ListViewItem li, string name, string disabled)
        {
        ...
        private static void addChoiceField(XmlNode nd, ListViewItem li, string name, string disabled)
        {
            Font f = new Font("Arial", 9, GraphicsUnit.Pixel);
            ComboBox cbo = new ComboBox();
            cbo.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        private static void addUserField(XmlNode nd, ListViewItem li, string name, CheckResources.resListStruct[] resList, string disabled)
        {
            Font f = new Font("Arial", 9, GraphicsUnit.Pixel);
            ComboBox cbo = new ComboBox();
            cbo.DropDownStyle = ComboBoxStyle.DropDownList;
