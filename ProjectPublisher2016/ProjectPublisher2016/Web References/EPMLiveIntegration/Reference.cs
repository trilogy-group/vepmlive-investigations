...
namespace ProjectPublisher2016.EPMLiveIntegration {
    using System;
    ...
    public partial class Integration : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Integration() {
            this.Url = global::ProjectPublisher2016.Properties.Settings.Default.ProjectPublisher2016_EPMLiveIntegration_Integration;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://epmlive.com/execute", RequestNamespace="http://epmlive.com/", ResponseNamespace="http://epmlive.com/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public System.Xml.XmlNode execute(string commandMethod, string commandText) {
        ...
        /// <remarks/>
        public void executeAsync(string commandMethod, string commandText) {
            this.executeAsync(commandMethod, commandText, null);
        }
        
        /// <remarks/>
        public void executeAsync(string commandMethod, string commandText, object userState) {
            ...
            this.InvokeAsync("execute", new object[] {
                        commandMethod,
                        commandText}, this.executeOperationCompleted, userState);
        }
