...
<tr>
	    ...
	    <tr>
                ...
                <td><asp:Label ID="lblAccountRef" runat="server"></asp:Label></td>
            </tr>
	    <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>Account Description:</td>
                <td><asp:TextBox ID="txtDesc" runat="server" Width="100"></asp:TextBox></td>
            </tr>
            <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>Months Free:</td>
                <td><asp:TextBox ID="txtMonthsFree" runat="server" Width="50"></asp:TextBox></td>
            </tr>
            <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>Trial Users:</td>
                <td><asp:TextBox ID="txtTrialUsers" runat="server" Width="50"></asp:TextBox></td>
            </tr>
	    <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>Linked Partner Id:</td>
                <td><asp:TextBox ID="txtPartnerId" runat="server" Width="50"></asp:TextBox> <a href="http://www.workengine.com/partners/Lists/Partners/PartnerIds.aspx" target="_blank">[Find an ID]</a></td>
            </tr>
	    <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>Dedicated:</td>
                <td><asp:CheckBox ID="chkDedicated" runat="server"></asp:CheckBox> (Check this if users should not receive system upgrade notices due to being on a dedicated system)</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><asp:Label ID="lblZuoraLink" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>Lock Users:</td>
                <td><asp:CheckBox ID="chkLockUsers" runat="server" /> Select this option to prevent the owner from purchasing additional users.</td>
            </tr>
            ...
            <tr>
                ...
                <td><asp:Label ID="txtEditFirstName" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td width="100" bgcolor="#c9c9c9">Last Name:</td>
                <td><asp:Label ID="txtEditLastName" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>E-Mail:</td>
                <td><asp:Label ID="lblEditEmail" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>Company:</td>
                <td><asp:Label ID="txtEditCompany" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>Title:</td>
                <td><asp:Label ID="txtEditTitle" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>Department:</td>
                <td><asp:Label ID="txtEditDepartment" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td width="100" bgcolor="#c9c9c9" nowrap>Phone:</td>
                <td><asp:Label ID="txtEditPhone" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td colspan="2"><br /><input type="button" value="Change Owner" class="searchbutton" onclick ="changeowner();" style="width:100px">
