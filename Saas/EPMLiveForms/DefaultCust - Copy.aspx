	...
	<div id="login-main">
		...
		<div id="footer-content">
			...
			<div style="padding-top:13px;font-size:.7em;">
				<span><a target="_blank" href="http://support.epmlive.com">Support</a></span>&nbsp;|&nbsp;<span><a href="https://epmlive.ideas.aha.io/" target="_blank">Feedback</a></span>&nbsp;|&nbsp;<span><a target="_blank" href="http://epmlive.com/epm-live-service-agreement">Legal</a></span>&nbsp;|&nbsp;<span><a target="_blank" href="http://uplandsoftware.com/privacy">Privacy Policy</a></span>
			</div>
		</div>
	</div>
	<div id="login-ad-main">
		<div id="login-ad-content">
			<div id="login-ad-bg">
				...
				<div style="color:#ffffff;font-size:25px;text-align:center;padding-top:20px;line-height:35px;">Visit the new Upland Community<br> for EPM Live</div>
        			<a href="https://community.uplandsoftware.com" target="_blank" style="text-decoration:none;">
