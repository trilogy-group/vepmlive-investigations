...
{
    public partial class createsite2 : LayoutsPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string rootFilePath = EPMLiveCore.CoreFunctions.getFarmSetting("WorkEngineStore") + "/Solutions/" + EPMLiveCore.CoreFunctions.GetAssemblyVersion() + "/";

            string template = rootFilePath + Request["template"];
