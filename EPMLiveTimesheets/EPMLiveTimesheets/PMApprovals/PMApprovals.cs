...
namespace TimeSheets
{
    ...
    public class PMApprovals : Microsoft.SharePoint.WebPartPages.WebPart, IWebPartPageComponentProvider
    {
        ...
        private void renderGrid(HtmlTextWriter output, SPWeb web)
        {
            ...
            output.Write($"mygrid{sFullGridId}.loadXML(\"{web.Url}/_layouts/epmlive/getpmapprovals.aspx?data={sFullParamList}");
            output.Write($"&source={HttpUtility.UrlEncode(HttpContext.Current.Request.Url.ToString())}&rnd={Guid.NewGuid()}&period={intPeriod}&width=\" + w);");
            output.Write("}");
        ...
        private void AppendMyGridScripts(HtmlTextWriter output, SPWeb web)
        {
            ...
            output.WriteLine($"mygrid{sFullGridId}._formmenus = \"{GetFormMenus(web)}\";");
        ...
        private string GetFormMenus(SPWeb web)
        {
        ...
        private void AppendGridScripts(HtmlTextWriter output, SPWeb web)
        {
        ...
        private void AppendDialogWindows(HtmlTextWriter output)
        {
            output.Write($"<div id=\"tsnotesgrid{ID}\" style=\"display:none; border: 1px solid #808080; padding: 3px; background-color: #F9F9F9; width:200px;height:100px\">");
            ...
            output.Write("<div id=\"dlgProcessing\" class=\"dialog\"><table width=\"100%\"><tr><td align=\"center\" class=\"ms-sectionheader\"><img src=\"/_layouts/images/GEARS_ANv4.GIF\" style=\"vertical-align: middle;\"/>");
            output.Write("<br /><H3 class=\"ms-standardheader\">Processing Items...</h3></td></tr></table></div>");
            output.Write("<div id=\"dlgEmailing\" class=\"dialog\"><table width=\"100%\"><tr><td align=\"center\" class=\"ms-sectionheader\"><img src=\"/_layouts/images/GEARS_ANv4.GIF\" style=\"vertical-align: middle;\"/>");
