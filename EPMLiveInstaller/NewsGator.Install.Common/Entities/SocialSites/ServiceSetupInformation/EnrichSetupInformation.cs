...
{
    internal static class EnrichSetupInformation
    {
        internal static Type SetupInformationType
        {
            get
            {
                return Utilities.Types.TryGetType(NGTypes.Enrich.EnrichSetupInformationTypeFullName, NGAssemblies.Enrich.NewsGatorLearningCommon);
            }
        }
