...
namespace EPMLiveDashboards.Tests
{
    ...
    public class ProjectDataTests
    {
        ...
        public void BuildData_Exception_ReturnsString()
        {
            ...
            // Assert
            actualResult.ShouldBe("Object reference not set to an instance of an object.   at Dashboard.ProjectData.buildData(Boolean pTasks, Boolean pRisks, Boolean pIssues)");
        }
