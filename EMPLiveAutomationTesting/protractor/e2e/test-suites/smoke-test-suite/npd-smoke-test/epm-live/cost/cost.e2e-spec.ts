...
describe(SuiteNames.smokeTestSuite, () => {
    ...
    it('Validate Edit Cost Functionality in Cost Planner - [743932]', async () => {
        ...
        await PageHelper.actionSendKeys(CommonPage.cellTextBox1, CommonPageConstants.costData.firstData, true);
        ...
        await PageHelper.actionSendKeys(CommonPage.cellTextBox2, CommonPageConstants.costData.secondData, true);
        ...
        await PageHelper.actionSendKeys(CommonPage.cellTextBox3, CommonPageConstants.costData.secondData, true);
