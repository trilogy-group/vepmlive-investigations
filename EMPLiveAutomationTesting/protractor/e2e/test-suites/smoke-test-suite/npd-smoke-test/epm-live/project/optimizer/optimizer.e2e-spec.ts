...
describe(SuiteNames.smokeTestSuite, () => {
    ...
    it('Save View  - [785307]', async () => {
        ...
        await expect(OptimizerPage.saveViewPopup.viewName.isPresent()).toBe(true);
        ...
        if (!(await label.personalView.isSelected())) {
        ...
        await expect(await OptimizerPage.viewManagementOptions.currentViewDropdown.getText()).toEqual(viewName);
        ...
        await PageHelper.click(OptimizerPage.getTabOptions(OptimizerPageConstants.tabOptions.view));
        await WaitHelper.getInstance().waitForElementToBeDisplayed(OptimizerPage.viewManagementOptions.saveView, PageHelper.timeout.s);
        stepLogger.verification('Previously Saved view displayed in the drop down');
