...
<SharePoint:RenderingTemplate ID="GanttViewToolBar" runat="server">
	<Template>
		<wssuc:ToolBar CssClass="ms-menutoolbar" EnableViewState="false" id="toolBarTbl" ButtonSeparator="<img src='/_layouts/images/blank.gif' alt=''>" RightButtonSeparator="&nbsp;&nbsp;" runat="server">
			...
			<Template_RightButtons>
			    <asp:HyperLink runat="server" ID="hlGanttScrollTo" ImageUrl="/_layouts/epmlive/images/scrollto.GIF" NavigateUrl="" />
