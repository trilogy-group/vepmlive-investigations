...
if (!window.Visifire) {
    ...
    */
    ...
    /*  Set the culture (language) to use for the chart formatting
    pCulture  => The culture name to use. For examples Dutch(Netherlands) is ne-NE.
    */
    Visifire.prototype.setCulture = function (pCulture) {
    ...
    */
    Visifire.prototype._render = function (pTargetElement) {
        ...
        if (this.culture != null) {
            html += '<param name="uiculture" value="' + this.culture + '"/>';
            html += '<param name="culture" value="' + this.culture + '"/>';
        }

        html += '<param name="background" value="transparent"/>';
        html += '<param name="windowless" value="true"/>';
        html += '<param name="source" value="' + vThisObject.xapPath + '?nocachetoken=' + new Date().getTime() + '"/>';
        ...
        //NOTE: RHS - Commented out the windowless parameter because it is being hardcoded in another section of this code.        
