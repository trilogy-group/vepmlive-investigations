...
using SocialStreamControl = EPMLiveWebParts.CONTROLTEMPLATES.SocialStream;
using Microsoft.QualityTools.Testing.Fakes;
using Microsoft.SharePoint.Fakes;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using Shouldly;

namespace EPMLiveWebParts.Tests.ControlTemplates
{
    /// <summary>
    /// Unit test for <see cref="SocialStreamControl"/> class.
    /// </summary>
    [TestClass, ExcludeFromCodeCoverage]
    public class SocialStreamTests
    {
        private IDisposable _shimsObject;
        private SocialStreamControl _testObj;
        ...
        public void SetUp()
        {
            ...
            _testObj = new SocialStreamControl();
