	...
	PRD_IS_CLOSED tinyint NOT NULL DEFAULT 0,
                ...
                begin
								...
								BEGIN
										...
										ADD ID int IDENTITY NOT NULL CONSTRAINT PK_EPG_PERIODS PRIMARY KEY NONCLUSTERED(ID) 
								END
                end
...
(
	...
	CONSTRAINT [PK_EPG_RESOURCES] PRIMARY KEY NONCLUSTERED ( [WRES_ID] ASC )
)
                ...
                begin
								...
								BEGIN
										ALTER TABLE [dbo].[EPG_RESOURCES] ADD  CONSTRAINT [PK_EPG_RESOURCES] PRIMARY KEY NONCLUSTERED ([WRES_ID] ASC)
								END								
                end
