    ...
    public class dbaEditCosts
    {
        ...
        public static StatusEnum SelectCostCategoryData(DBAccess dba, int nCalendarID, int nCostTypeID, int nProjectID, out DataTable dt)
        {
            ...
            try
            {
                ...
                //    + "ORDER BY BC_ID ";
                string cmdText =
                      "SELECT BC.*,CD.BC_UID as Used,CD.BC_SEQ as Seq,CD.RT_UID,R.RT_NAME,"
                    + "LV1.LV_VALUE as LV_01, LV2.LV_VALUE as LV_02, LV3.LV_VALUE as LV_03, LV4.LV_VALUE as LV_04, LV5.LV_VALUE as LV_05,"
